...
this.yearMenu.items=_3;this.yearMenu.setPageRect(_9,_6,_7,_8)}
...
if(this.awaitingImplicitSave)delete this.awaitingImplicitSave;this.logInfo("implicitSave called "+(!_2?"by editorExit()":"after implicitSaveDelay ("+this.implicitSaveDelay+"ms)")+" for item "+_1.name+".");if(this.valuesManager){this.valuesManager.saveData(this.getID()+".$888(data)",{showPrompt:false})}else{this.saveData(this.getID()+".$888(data)",{showPrompt:false})}}
...
);isc.evalBoundary;isc.B.push(isc.A.itemHoverHTML=function isc_DynamicForm_itemHoverHTML(_1){if(_1.implementsPromptNatively)return null;var _2=_1.prompt;if(!_2&&_1.parentItem)_2=this.itemHoverHTML(_1.parentItem)
return _2}
...
);isc.B._maxIndex=isc.C+233;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$77j="section";isc.A.$77k="SectionItem";isc.A.$77l="button";isc.A.$77m="ButtonItem";isc.A.$450="id";isc.A.$refPropName="__ref";isc.B.push(isc.A.getEditorType=function isc_c_DynamicForm_getEditorType(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.canEditField(_1,_2),_5=this.defaultFieldType,_6=(_4==false&&_1.readOnlyEditorType)||_1.editorType||_1.formItemType||_1._constructor||_1.type||_5;if((_4==false&&_1.readOnlyEditorType)||_1.editorType||_1.formItemType||_1._constructor)
{return _6}
...
var _11=_3.$89d(_4,_5);if(_2.setValue){_2.setValue(_11)}else if(_5&&_5.setValue){var _12=_2.fieldName;if(_12==null)_12=_2.dataPath;_5.setValue(_12,_11)}}},setRequired:{type:"setRequired",valueType:"none",dataType:"none",isRule:true,supportedTargets:["FormItem"],action:function(_1,_2,_3,_4,_5){var _6=!!_1;var _7=_2;if(!_7.setRequired&&_5.getItem){_7=_5.getItem(_2.name||_2.dataPath)}
...
,isc.A.processValidator=function isc_c_Validator_processValidator(_1,_2,_3,_4,_5){if(_2.serverOnly)return true;if(_4==null)_4=isc.Validator.getValidatorType(_2);var _6=true;var _7;if(_4!=null)_7=this.$74u[_4];if(_2.isRule||_7.isRule)return true;var _8;if(_7==null){if(_2.condition){if(!isc.isA.Function(_2.condition)){this.logDebug("Creating function for validation condition:\r"+_2.condition);isc.Func.replaceWithMethod(_2,"condition","item,validator,value,record")}
...
return _6}
,isc.A.performAction=function isc_c_Validator_performAction(_1,_2,_3,_4,_5,_6){var _7=this.getValidatorType(_3);var _8;if(_7!=null)_8=this.$74u[_7];if(_6==null)_6="FormItem";var _9=_3.isRule,_10=_3.supportedTargets;var _11;if(_8!=null){_11=_8.action;if(_9==null)_9=_8.isRule;if(_9&&_10==null){_10=_8.supportedTargets||["FormItem"]}}
...
_11=_3.action}
if(_11!=null){_11(_1,_2,_3,_4,_5,_6)}}
...
,isc.A.destroy=function isc_CanvasItem_destroy(){if(this.canvas){delete this.canvas.canvasItem;if(this.autoDestroy){this.canvas.destroy(true)}else{this.canvas.addProperties(this.canvas.$906);delete this.canvas.$906;if(this.canvas.isDrawn()){this.canvas.clear()}
...
if((_4==null||!_3)&&(_5==null||_5==_6))return _1;var _7=this.pickList&&!this.pickList.destroyed?(this.pickList.originalData||this.pickList.data):null;if(_7==null)return;var _8;if(isc.isAn.Array(_7)){_8=_7}else{_8=_7.allRows||_7.localData}
if(_8==null)return;var _9=(_2?_6:_5||_6),_10=(_2?_5||_6:_6);var _11;if(isc.isAn.Array(_1)){_11="";var _12=isc.shallowClone(_1);for(var i=0;i<_1.length;i++){var _14=_12[i];var _15=_8.find(_10,_1[i]);if(_15!=null){_11+=_15[_9]}else continue;if(i!=_1.length-1)_11+=this.multipleValueSeparator}}else{var _15=_8.find(_10,_1);if(_15!=null)_11=_15[_9]}
return _11},$18q:"true",setUpPickListFields:function(){var _1=this.getPickListFields(),_2=this.pickList.fields;var _3=!_2||(_2.length!=_1.length);if(!_3){for(var i=0;i<_1.length;i++){var _5=_1[i],_6=_2[i];for(var _7 in _5){if(_5[_7]!=_6[_7]){_3=true;break}}
if(_3)break}}
...
,isc.A.makePickList=function isc_SelectItem_makePickList(_1){if(this.progressiveLoading===true||this.progressiveLoading===false){if(this.pickListProperties==null)this.picklistProperties={};this.picklistProperties.progressiveLoading=this.progressiveLoading}
...
if(this.pickList&&this.pickList.data){_1=this.pickList.data.find(this.getValueFieldName(),this._value);if(_1!=null){this.$848([_1]);this.$846()}}}
return _1}
...
,isc.A.setMinValue=function isc_SliderItem_setMinValue(_1){this.canvas.setMinValue(_1);this.minValue=_1}
,isc.A.setMaxValue=function isc_SliderItem_setMaxValue(_1){this.canvas.setMaxValue(_1);this.maxValue=_1}
,isc.A.setNumValues=function isc_SliderItem_setNumValues(_1){this.canvas.setNumValues(_1);this.numValues=_1}
...
this.Super("init",arguments)}
,isc.A.changed=function isc_PresetCriteriaItem_changed(_1,_2,_3){if(_3=="customOption"){if(this.getCustomCriteria&&isc.isA.Function(this.getCustomCriteria))
this.getCustomCriteria(this.getID()+".getCustomCriteriaReply(criteria,title)")}}
,isc.A.getCustomCriteria=function isc_PresetCriteriaItem_getCustomCriteria(_1){}
,isc.A.getCustomCriteriaReply=function isc_PresetCriteriaItem_getCustomCriteriaReply(_1,_2){this.valueMap["customOption"]=_2;this.options["customOption"]=_1}
,isc.A.getCriteriaValue=function isc_PresetCriteriaItem_getCriteriaValue(){return this.getCriterion()}
,isc.A.hasAdvancedCriteria=function isc_PresetCriteriaItem_hasAdvancedCriteria(){return true}
,isc.A.getCriterion=function isc_PresetCriteriaItem_getCriterion(){var _1=this.getValue(),_2=this.options[_1];var _3=_2;return _3}
,isc.A.updateCriteriaFieldNames=function isc_PresetCriteriaItem_updateCriteriaFieldNames(_1){for(var _2 in _1){var _3=_1[_2];if(isc.DataSource.isAdvancedCriteria(_3)){_3=this.updateCriteriaFieldNames(_3)}else{if(!_3.fieldName){_3.fieldName=this.getCriteriaFieldName()}}}
return _1}
,isc.A.setValue=function isc_PresetCriteriaItem_setValue(_1){_1=this.matchCriteria(_1);this.Super("setValue",arguments)}
,isc.A.canEditCriterion=function isc_PresetCriteriaItem_canEditCriterion(_1){return true}
,isc.A.setCriterion=function isc_PresetCriteriaItem_setCriterion(_1){this.setValue(isc.shallowClone(_1))}
,isc.A.getCriterion=function isc_PresetCriteriaItem_getCriterion(){var _1=this.getValue(),_2=this.options[_1];return _2}
,isc.A.matchCriteria=function isc_PresetCriteriaItem_matchCriteria(_1,_2){var _3=_2||this.options;for(var _4 in _3){var _5=_3[_4];if(this.objectsAreEqual(_5,_1)){return _4}}
return _1}
,isc.A.objectsAreEqual=function isc_PresetCriteriaItem_objectsAreEqual(_1,_2){if(!_1&&!_2)return true;if(!_1||!_2)return false;for(var _3 in _1){if(_3=="_constructor")continue;var _4=_1[_3],_5=_2[_3];if(isc.isAn.Array(_4)){for(var i=0;i<_4.length;i++){if(isc.isAn.Object(_4[i])){if(!this.objectsAreEqual(_4[i],_5[i]))return false}else{if(_4[i]!=_5[i])return false}}}else if(isc.isAn.Object(_4)){if(!this.objectsAreEqual(_4,_5))return false}else{if(_1[_3]!=_2[_3])return false}}
return true}
);isc.B._maxIndex=isc.C+14;isc.defineClass("PresetDateRangeItem","PresetCriteriaItem");isc.A=isc.PresetDateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.customOptionTitle="Custom Date Range";isc.B.push(isc.A.getCustomCriteria=function isc_PresetDateRangeItem_getCustomCriteria(_1){this.$03=_1;isc.DateRangeDialog.askForRange(true,{returnCriterion:true},null,this.getID()+".showDateRangeDialogReply(value)")}
,isc.A.showDateRangeDialogReply=function isc_PresetDateRangeItem_showDateRangeDialogReply(_1){var _2=this.$03;delete this.$03;this.fireCallback(_2,"criteria,title",[_1,this.customOptionTitle])}
