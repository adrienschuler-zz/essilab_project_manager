...
return-1}
,isc.A.getChildren=function isc_Tree_getChildren(_1,_2,_3,_4,_5,_6){if(_3==null&&this.$27i==null&&this.separateFolders){this.sortByProperty();_3=this.$27i}
...
var _8=_1[this.childrenProperty],_9,i;if(_5){_9=[];for(i=0;i<_8.length;i++){var _11=_8[i];if(this.fireCallback(_5,"node,parent,tree",[_11,_1,this]))
_9[_9.length]=_11}
_8=_9}
if(_2==isc.Tree.FOLDERS_ONLY){_9=[];for(i=0;i<_8.length;i++){if(this.isFolder(_8[i]))_9[_9.length]=_8[i]}}else if(_2==isc.Tree.LEAVES_ONLY){_9=[];for(i=0;i<_8.length;i++){if(this.isLeaf(_8[i]))_9[_9.length]=_8[i]}}else{_9=_8}
if(_3){var _12=this.$73p?this.$73p.getProperty("property"):[];if(this.$73p){for(var _13=0;_13<this.$73p.length;_13++){if(!this.$73p[_13].normalizer){this.$73p[_13].normalizer=_3}}}
if(!this.$684||this.alwaysSortGroupHeaders||(!_12.contains(this.$684)&&_1!=this.getRoot())||(_12.contains(this.$684)&&_1==this.getRoot()))
{if(this.$73p){_9.setSort(this.$73p)}}}
return _9}
...
,isc.A.sortByProperty=function isc_Tree_sortByProperty(_1,_2,_3,_4){if(!_1&&this.sortProp)_1=this.sortProp;if(!_2)_2=this.sortDirection;this.setSort([{property:_1||"title",direction:(isc.isA.String(_2)?_2:(_2==true)?"ascending":"descending"),normalizer:_3,context:_4}])}
,isc.A.setSort=function isc_Tree_setSort(_1){if(!_1||!_1.length){if(this.sortProp){_1=[{property:this.sortProp,direction:(isc.isA.String(direction)?direction:(direction==true)?"ascending":"descending")}]}}
this.$73p=_1;this.$27n();this.$45g=_1?_1[0].context:null;this.$736(true);this.dataChanged()}
...
var _7=this.$73p;if(_7&&_7.length){for(var i=0;i<_7.length;i++){var _9=_7[i].property;if(_9&&_9!="title"){_4.append("var prop = obj['",_9,"'];\r","if (isc.isA.Number(prop)) {\r","if (prop > 0) prop = '1' + prop.stringify(12,true);\r","else {\r","prop = 999999999999 + prop;\r","prop = '0' + prop.stringify(12,true);\r","}\r","} else if (isc.isA.Date(prop)) prop = prop.getTime();\r","if (prop != null) value += prop + ':';\r")}}}
if(_7&&(_7.length>1||_7[0].property!="title")){_4.append("var title = __tree__.getTitle(obj);\r","if (isc.isA.Number(title)) {\r","if (title > 0) title = '1' + title.stringify(12,true);\r","else {\r","title = 999999999999 + prop;\r","title = '0' + title.stringify(12,true);\r","}\r","} else if (isc.isA.Date(title)) title = title.getTime();\r","if (title != null) {title = title + ''; value += title.toLowerCase();\r}\r")}
...
var _7=this.getFieldHilites(_1,_2);if(_7!=null){_3=this.applyHiliteHTML(_7,_3);_3=this.applyHiliteIcon(_7,_2,_3)}
return _3}
...
if(_5)_6.$84t(_3,_2)});return}else{_6.$90t(_8,_7);if(_5)this.$84t(_3,_2);return}}}
,isc.A.$90t=function isc_ListGrid__saveExpansionEditorValues(_1,_2){for(var _3 in _2){this.setEditValue(_1,_3,_2[_3])}}
,isc.A.saveExpansionDetail=function isc_ListGrid_saveExpansionDetail(_1,_2,_3,_4){var _5=this;_1.saveData(function(_6,_7,_8){if(_7){_3=_7;if(_4)_5.$84t(_3,_2);else _1.editRecord(_3)}},{showPrompt:true,promptStyle:"cursor"})}
...
return null}
,isc.A.getExpansionComponent=function isc_ListGrid_getExpansionComponent(_1){return this.$84d(_1,true,false,this.getRecordIndex(_1),0)}
...
this.canMultiSort=this.getDataSource().canMultiSort&&this.canSort;var _3=this.getSort();if(_3)this.setSort(_3);if(isc.ResultSet&&isc.isA.ResultSet(this.data)&&!(this.data.allRows&&this.data.neverDropCache)&&this.body&&this.body.overflow=="visible")
...
if(_8!==_10){return _8}else{if(_1==null)return this.emptyCellValue;if(this.data.getFieldValue&&_5){_9=this.data.getFieldValue(_1,_6,_5,this)}else if(_1.ownerDocument&&_5){_9=isc.xml.getFieldValue(_1,_6,_5)}else{_9=isc.Canvas.$70o(_5,_1,this,true);if(_9==null)_9=_1[_6]}}
...
return _9}
,isc.A.$840=function isc_ListGrid__trimDataPath(_1){return isc.Canvas.$840(_1,this)}
...
if(_13){if(!_22||isc.isAn.emptyString(_22))_22=this.emptyCellValue;_9=_22}else{_9=this.$315(_9,_1,_8,_2,_3);var _23=this.getFieldHilites(_1,_8);if(_23!=null)_9=this.applyHiliteHTML(_23,_9);if(_22){if(_8.valueIconOrientation!=isc.Canvas.RIGHT)
_9=_22+_9;else
_9=_9+_22}}
if(this.isEditable()&&this.showErrorIcons&&this.cellHasErrors(_2,_3)){_9=this.getErrorIconHTML(_2,_3)+_9}
var _8=this.fields[_3];var _23=this.getFieldHilites(_1,_8);if(_23!=null){_9=this.applyHiliteIcon(_23,_8,_9)}}}
...
,isc.A.setRawCellValue=function isc_ListGrid_setRawCellValue(_1,_2,_3,_4){var _5=this.fields[_3];if(!_1||!_5)return;if(_5.setRawCellValue){isc.Func.replaceWithMethod(_5,"setRawCellValue","viewer,record,recordNum,field,fieldNum,value");_5.setRawCellValue(this,_1,_2,_5,_3,_4)}else{isc.Canvas.$70n(_5,_4,_1,this,true)}
...
_11=this.createAutoChild("expansionDetailRelated",_15)}else if(_14=="editor"){_11=isc.VLayout.create({autoDraw:false,width:"100%",height:"100%",creator:this});var _18=this.createAutoChild("expansionEditor",{dataSource:this.dataSource,fields:_10,extraSpace:5,itemChanged:function(){this.saveButton.setDisabled(false)}});_18.editRecord(this.getEditedRecord(_4)||_1);_18.validate();var _19=this.createAutoChild("expansionEditorSaveButton",{title:this.expansionEditorSaveButtonTitle,grid:this,form:_18,record:_1,disabled:true,extraSpace:5});_18.saveButton=_19;_11.formMember=_18;_11.addMembers([_18,_19])}
return _11}
...
,isc.A.$336=function isc_ListGrid__saveLocally(_1,_2){var _3=_1.rowNum,_4=_1.colNum,_5=_1.oldValues,_6=_1.values;var _7=this.getCellRecord(_3,_4),_8=(_7==null);if(_8){var _9=this.getData();var _10=this.getEditSession(_3);_10.$33b=this.getPrimaryKeys(_6);delete _10.$33i;if(isc.ResultSet&&isc.isA.ResultSet(_9)){if(_9.allRows!=null){_9.allRows.add(_9);_9.filterLocalData()}else{isc.logWarn("Unable to add data to resultSet - allRows is not set")}}else{_9.add(_6);_9.dataChanged()}}else{var _11,_12;var _13={};for(var i=0;i<this.completeFields.length;i++){var _15=this.completeFields[i],_16=this.getEditorName(_3,_15,true);_11=isc.Canvas.$70o(this.$840(_16),_6,this,true);if(_11!==_12){var _17=this.fields.indexOf(_15);if(_17!=-1){this.setRawCellValue(_7,_3,_17,_11)}else{if(_15.dataPath){isc.Canvas.$70n(this.$840(_15.dataPath),_11,_7,this,true)}else{_7[_15[this.fieldIdProperty]]=_11}}}
var _18=_16;if(_16.indexOf("/")>=0){_18=_16.substring(0,_16.indexOf("/"))}
_13[_18]=true}
...
);isc.evalBoundary;isc.B.push(isc.A.parseServerErrors=function isc_ListGrid_parseServerErrors(_1){if(isc.isAn.Array(_1)){if(_1.length>1){this.logWarn("server returned errors for multiple records - dropping all but the "+"first record returned")}
_1=_1[0]}
...
,isc.A.$331=function isc_ListGrid__editFailedCallback(_1,_2,_3,_4){var _5=_1.rowNum,_6=_1.colNum,_7=_1.values,_8=_1.oldValues,_9=_1.editCompletionEvent;if(this.canExpandRecord(_5)&&this.expansionMode=="editor"){var _10=isc.isAn.Array(_3.errors)?_3.errors[0]:_3.errors,_11=this.getRecord(_5),_12=false;if(isc.isAn.Object(_10)){for(var _13 in _10){var _14=this.getField(_13);if(!_14||!this.fieldIsVisible(_14)){_12=true;break}}}
...
if(_10<0)continue;var _11=((_7&&this.canEditCell(_3,_10))||isc.propertyDefined(_1,_9));var _12,_13;if(!_11){var _14=this.getField(_9),_15=_14?_14.dataPath:null,_16;if(_15!=null){_12=isc.Canvas.$70o(this.$840(_15),_1,this,true);_13=isc.Canvas.$70o(this.$840(_15),_2,this,true);_11=(_12!==_16||_13===_16)}}else{_12=_1[_9];_13=_2[_9]}
...
if(this.data){var _4=this.getEditValuesID(_1);if(_4!=null)this.discardEdits(_4);if(isc.ResultSet&&isc.isA.ResultSet(this.data)&&this.shouldSaveLocally()){if(this.data.allRows!=null){this.data.allRows.remove(_1);this.data.filterLocalData()}else{isc.logWarn("Unable to remove data from resultSet - allRows is not set")}}else{this.getOriginalData().remove(_1)}
...
,isc.A.getDisplayValue=function isc_ListGrid_getDisplayValue(_1,_2,_3){var _4=this.getField(_1),_5=_4?_4.valueMap:null;if(_4){if(isc.isAn.Object(_5)&&!isc.isAn.Array(_5)&&isc.propertyDefined(_5,_2))
...
);isc.evalBoundary;isc.B.push(isc.A.bodyOverflowed=function isc_ListGrid_bodyOverflowed(){if(this.summaryRow!=null&&this.summaryRow.body){this.summaryRow.body.setRightSpace(this.body.vscrollOn?this.body.getScrollbarSize():0)}
...
if(_9){var _11=(!_2.getGroupValue?_2.groupingModes?_2.groupingModes:(_2.$62?(_2.$62.getGroupingModes)?_2.$62.getGroupingModes():_2.$62.groupingModes:false):false);var _12=null;if(_11){_12=[];for(var _13 in _11){_12.add({title:_11[_13],groupType:_13,targetField:_2,fieldName:_2.name,prompt:_2.prompt,checked:(_2.groupingMode==_13),click:function(_14,_15,_16){this.targetField.groupingMode=this.groupType;_16.$35q.groupField(_15)}})}}
...
,isc.A.$52u=function isc_ListGrid__addRecordToGroup(_1,_2,_3){var _4,_5=this.groupTree.getRoot(),_6=this.getGroupByFields();for(var i=0;i<_6.length;i++){var _8=_6[i],_9=(this.completeFields||this.fields).findIndex(this.fieldIdProperty,_8),_10=(this.completeFields||this.fields).get(_9),_11=this.data.indexOf(_1);var _12=this.getRawCellValue(_1,_11,_8,true);if(_10.getGroupValue){_12=_10.getGroupValue(_12,_1,_10,_8,this)}else if(_10.userFormula){_12=this.getFormulaFieldValue(_10,_1)}else if(_10.userSummary){_12=this.getSummaryFieldValue(_10,_1)}else if(_10.$62&&_10.$62.getGroupValue){_12=_10.$62.getGroupValue(_12,_1,_10,_8,this)}else if(_10.displayField){var _13=this.getDisplayValue(_10.name,_12,_1);if(_13){_12=_13}}
if(_10.valueMap&&_10.valueMap[_12]){_12=_10.valueMap[_12]}
if(_12==null||isc.isAn.emptyString(_12)){_12=this.nullGroupTitle}
var _14=this.groupTree.getChildren(_5);if(_14==null)_4=null;else _4=_14.find('groupValue',_12);if(!_4){_4={groupName:_8,groupValue:_12,$52e:true,canDrag:false,canSelect:false};if(this.singleCellGroupHeaders())_4.singleCellValue=_12;else _4.groupTitle=_12;_4[_8]=_12;_4[this.recordCustomStyleProperty]=this.groupNodeStyle
...
_5=_4}
this.groupTree.add(_1,_5);if(_2){var _15=this.groupTree.getParents(_1);for(var i=_15.length-2,j=0;i>=0;i--,j++){var _17=this.getGroupTitle(_15[i]);if(!this.singleCellGroupHeaders())_15[i].groupTitle=_17;else _15[i][this.singleCellValueProperty]=_17}}}
...
);isc.evalBoundary;isc.B.push(isc.A.getOriginalData=function isc_ListGrid_getOriginalData(){return(this.isGrouped&&this.originalData)?this.originalData:this.getData()}
...
,isc.A.getUsedFields=function isc_FormulaBuilder_getUsedFields(){return this.getClass().getUsedFields(this.getValue(),this.getAvailableFields(),this.field,this.allowEscapedKeys)}
...
,isc.A.getUsedFields=function isc_c_FormulaBuilder_getUsedFields(_1,_2,_3,_4){var _5=this.getAvailableFields(_2,_3),_6=[];if(!_5||!_1)return _6;_5=_5.sortByProperties(["mappingKey"],[false],[function(_9,_10,_11){var _7=_9[_10];if(_7.length==1)_7='  '+_7;else if(_7.length==2)_7=' '+_7;return _7}]);for(var i=0;i<_5.length;i++){var _9=_5.get(i);if(_4){if(_1.indexOf("#"+_9.mappingKey)>=0||_1.indexOf("#{"+_9.mappingKey+"}")>=0)
{_6.add(_9)}}else if(_1.indexOf(_9.mappingKey)>=0){_6.add(_9)}}
return _6}
...
var _4={name:"icon",title:"Icon",type:"SelectItem",width:"*",defaultValue:"",valueMap:{"":""},valueIcons:{"":"[SKINIMG]/blank.gif"},disabled:true};if(this.hiliteIcons){this.hiliteIcons.map(function(_5){_4.disabled=false;_4.valueMap[_5]="";_4.valueIcons[_5]=_5})}
var _5=this.hilite?this.hilite.icon:null;if(_5&&!_4.valueMap[_5]){_4.disabled=false;_4.valueMap[_5]="";_4.valueIcons[_5]=_5}
this.hiliteForm.addItems(_4);this.hiliteForm.setValue("icon",this.hilite?this.hilite.icon:"");this.addMember(this.hiliteForm)}}
...
var _1=this.hilite=isc.addProperties(this.hilite||{},{fieldName:this.fieldName}),_2=this.hiliteForm.getValue("colorType"),_3=this.hiliteForm.getValue("color"),_4=this.clause.getCriterion();_1.criteria=_4;_1.icon=this.hiliteForm.getValue("icon");if(_3){if(_2=="foreground"){_1.textColor=_3;_1.cssText="color:"+_3+";"}else{_1.backgroundColor=_3;_1.cssText="background-color:"+_3+";"}}
if(this.hilite&&this.hilite.id)_1.id=this.hilite.id;return _1}
,isc.A.editAdvancedRule=function isc_HiliteRule_editAdvancedRule(){var _1=this.getID()+".editAdvancedRuleReply(hilite)";this.advancedHiliteDialog=isc.Window.create({title:"Advanced Highlight Editor",width:Math.round(isc.Page.getWidth()/2),height:1,isModal:true,showModalMask:true,showResizer:true,autoSize:true,autoCenter:true,items:[isc.AdvancedHiliteEditor.create({width:"100%",height:"100%",dataSource:this.fieldDataSource?null:this.dataSource,fieldDataSource:this.fieldDataSource,hilite:this.hilite,hiliteIcons:this.hiliteIcons,callback:_1})]});this.advancedHiliteDialog.show()}
...
,isc.A.addHilite=function isc_HiliteEditor_addHilite(_1){var _2=this.createAutoChild("hiliteRule",{width:"100%",fieldName:_1.name,dataSource:this.dataSource,hiliteIcons:this.hiliteIcons});this.showNewHilite(_2)}
...
,isc.A.addAdvancedHiliteReply=function isc_HiliteEditor_addAdvancedHiliteReply(_1){this.advancedHiliteDialog.hide();this.advancedHiliteDialog.markForDestroy();if(!_1)return;var _2=this.createAutoChild("hiliteRule",{width:"100%",isAdvanced:true,dataSource:this.dataSource,fieldDataSource:this.fieldDataSource,fieldName:_1.fieldName,hilite:_1,hiliteIcons:this.hiliteIcons});this.showNewHilite(_2)}
...
,isc.A.setHilites=function isc_HiliteEditor_setHilites(_1){_1=this.hilites=_1||[];for(var i=0;i<_1.length;i++){var _3=_1[i],_4=this.createAutoChild("hiliteRule",{fieldName:_3.fieldName,hilite:_3,dataSource:this.dataSource,hiliteIcons:this.hiliteIcons});this.showNewHilite(_4)}}
...
);isc.B._maxIndex=isc.C+17;isc.defineClass("AdvancedHiliteEditor","VStack");isc.A=isc.AdvancedHiliteEditor.getPrototype();isc.A.padding=10;isc.A.membersMargin=10;isc.A.filterBuilderDefaults={_constructor:"FilterBuilder",isGroup:true,groupTitle:"Filter",padding:8,maxHeight:200,overflow:"visible"};isc.A.hiliteFormDefaults={_constructor:"DynamicForm",isGroup:true,groupTitle:"Appearance",extraSpace:4,padding:8,width:"100%",numCols:8,colWidths:[200,150,100,150,100,150,40,50]};isc.A.hiliteButtonsDefaults={_constructor:isc.HLayout,membersMargin:8,height:1};isc.A.saveButtonDefaults={_constructor:"IButton",autoParent:"hiliteButtons",title:"Save",click:function(){this.creator.saveHilite()}};isc.A.cancelButtonDefaults={_constructor:"IButton",autoParent:"hiliteButtons",title:"Cancel",click:function(){this.creator.cancelEditing()}};isc.A.defaultWidth=900;isc.A.defaultHeight=600;isc.A.visibilityMode="multiple";isc.A.invalidHilitePrompt="Enter at least one rule, a color or icon, and a target field, or press 'Cancel' to abandon changes.";isc.A=isc.AdvancedHiliteEditor.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function isc_AdvancedHiliteEditor_initWidget(){this.Super("initWidget",arguments);var _1=this.getDataSource(),_2=this;this.addAutoChild("filterBuilder",{dataSource:_1,fieldDataSource:this.fieldDataSource,fieldNameChanged:function(_12){this.Super("fieldNameChanged",arguments);_2.fieldChosen(_12.getFieldName())}});var _3={name:"icon",title:"Icon",type:"SelectItem",width:"*",defaultValue:"",valueMap:{"":""},valueIcons:{"":"[SKINIMG]/blank.gif"},disabled:true};if(this.hiliteIcons){this.hiliteIcons.map(function(_4){_3.disabled=false;_3.valueMap[_4]="";_3.valueIcons[_4]=_4})}
var _4=this.hilite?this.hilite.icon:null;if(_4&&!_3.valueMap[_4]){_3.disabled=false;_3.valueMap[_4]="";_3.valueIcons[_4]=_4}
var _5=[{title:"Target Field(s)",name:"fieldName",multiple:true,allowMultiSelect:true,type:"select"},{title:"Text",name:"textColor",type:"color"},{title:"Background",name:"backgroundColor",type:"color"},_3];this.addAutoChild("hiliteForm");if(this.fieldDataSource){_5[0]=isc.addProperties({},_5[0],{valueField:"name",displayField:"title",optionDataSource:this.fieldDataSource});delete _5[0].defaultDynamicValue;this.hiliteForm.addItems(_5)}else{var _6=this.fieldNames||_1.getFieldNames(),_7=this.fieldMap={};for(var i=0;i<_6.length;i++){var _9=_6[i],_10=_1.getField(_9),_11=_10.title;if(_10.hidden)continue;_11=_11?_11:_9;_7[_9]=_11}
this.fieldMap=_7;_5[0].valueMap=_7;this.hiliteForm.addItems(_5)}
...
,isc.A.saveHilite=function isc_AdvancedHiliteEditor_saveHilite(){this.hiliteForm.setValue("criteria",this.filterBuilder.getCriteria());var _1=this.hiliteForm.getValues();if(_1.criteria.criteria==null||_1.criteria.criteria.length==0||(!_1.textColor&&!_1.backgroundColor&&!_1.icon)||_1.fieldName==null)
