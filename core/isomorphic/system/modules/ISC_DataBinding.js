...
return null}
,isc.A.getPathValue=function isc_c_DataSource_getPathValue(_1,_2){return isc.Canvas.$70o(_2,_1)}
,isc.A.setPathValue=function isc_c_DataSource_setPathValue(_1,_2,_3){isc.Canvas.$70n(_2,_3,_1)}
...
break;case"add":case"insert":var _16=isc.addProperties({},_1.data);_16=this.applySequenceFields(_16);_2.add(_16);_4.data=isc.addProperties({},_16);break;case"replace":case"update":var _15=this.findByKeys(_1.data,_2);if(_15==-1){this.logWarn("clientOnly update operation: Unable to find record matching criteria:"+this.echo(_1.data))}else{var _16=_2[_15];for(var _17 in _1.data){var _18=this.getField(_17);if(_18==null)_18=_17;isc.Canvas.$70n(_18,_1.data[_17],_16,null,true)}
...
for(var i=0,l=_1.length;i<l;i++){_7=_1[i];if(_7==null)continue;_8=true;for(j=0;j<_5;j++){_9=_4[j];if(_9==null)continue;var _19=this.getField(_9);if(this.dropUnknownCriteria&&!_19)continue;var _20=false;if(isc.isA.List(_15)&&_15.contains(_9)){_20=true}
if(!_20&&_19&&_19.customSQL)continue;_10=isc.DataSource.getPathValue(_7,_19==null?_9:_19);_11=_2[_9];if(!this.fieldMatchesFilter(_10,_11,_3)){_8=false;break}}
if(_8)_6.add(_7)}
return _6}
...
var _4=this.$901.applyFilter(_1,_2);return _4}
,isc.A.addSearchOperator=function isc_c_DataSource_addSearchOperator(_1){if(!_1||!_1.ID){isc.logWarn("Attempted to add null search operator, or operator with no ID");return}
...
);isc.B._maxIndex=isc.C+5;isc.DataSource.registerStringMethods({transformRequest:"dsRequest",transformResponse:"dsResponse,dsRequest,data"});isc.$571=function(){var _1=function(_65,_66,_46,_67,_68,_69){var _2;if(!_67.criteria){_67.criteria=[]}
...
if(_68.isNot)_69.$59u=!_69.$59u;return _2};var _5=function(_65,_66,_46,_67,_68,_69){var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);if(_69.$59v){if(_7==null||_65==null){return _69.$59u}}
var _8=(_65==_7);if(isc.isA.Date(_65)&&isc.isA.Date(_7)){_8=(_69.compareDates(_65,_7,_46)==0)}
if(_68.negate)return!_8;else return _8};var _9=function(_65,_66,_46,_67,_68,_69){var _10=_65,_11=_65;var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);if(_67.start)_10=_67.start;if(_67.end)_11=_67.end;if(_69.$59v){if(_7==null||(_68.lowerBounds&&_10==null)||(_68.upperBounds&&_11==null)){return _69.$59u}}
var _12=true;var _13=true;var _14=isc.isA.Date(_7);var _15=isc.isA.Number(_7);var _16=isc.isA.String(_7);if(_68.lowerBounds&&_10&&((_15&&isNaN(_10))||(_10&&_14&&(!isc.isA.Date(_10)))||(_10&&_16&&(!isc.isA.String(_10)&&!isc.isA.Number(_10))))){return false}
if(_68.upperBounds&&_11&&((_15&&isNaN(_11))||(_11&&_14&&(!isc.isA.Date(_11)))||(_11&&_16&&(!isc.isA.String(_11)&&!isc.isA.Number(_11))))){return false}
var _17;if(_10===null||_10===_17){_12=false}
if(_11===null||_11===_17){_13=false}
if(_14&&!isc.isA.Date(_10))_12=false;if(_14&&!isc.isA.Date(_11))_13=false;_14=isc.isA.Date(_10)||isc.isA.Date(_11);_15=isc.isA.Number(_10)||isc.isA.Number(_11);_16=isc.isA.String(_10)||isc.isA.String(_11);_6=_69.getField(_46);_7=isc.DataSource.getPathValue(_66,_6?_6:_46);var _18=_16&&_68.caseInsensitive;if(_7===null||_7===_17){if(_14)_7=new Date(-8640000000000000);else if(_15)_7=Number.MIN_VALUE;else _7=""}else{if(_15&&isNaN(_7)){_10=""+_10;_11=""+_11}
if(_14&&!isc.isA.Date(_7)){return false}}
if(_68.lowerBounds&&_12){if(_69.compareValues(_10,_7,_46,_18)<=(_68.inclusive?-1:0))
{return false}}
if(_68.upperBounds&&_13){if(_69.compareValues(_11,_7,_46,_18)>=(_68.inclusive?1:0))
{return false}}
return true};var _19=function(_65,_66,_46,_67,_68,_69){var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);var _20=_65;if(isc.isA.Number(_7))_7=""+_7;if(_7!=null&&!isc.isA.String(_7)){return _68.negate}
if(_7==null)return _69.$59v?_69.$59u:_68.negate;if(_20==null)_20="";if(isc.isA.Number(_20))_20=""+_20;if(!isc.isA.String(_20)||!isc.isA.String(_7))return _68.negate;if(_68.caseInsensitive){_7=_7.toLowerCase();_20=_20.toLowerCase()}
if(_68.startsWith)var _21=isc.startsWith(_7,_20);else if(_68.endsWith)_21=isc.endsWith(_7,_20);else if(_68.equals)_21=(_7==_20);else _21=isc.contains(_7,_20);if(_68.negate)return!_21;else return _21};var _22=function(_65,_66,_46,_67,_68,_69){var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);var _23=(_7==null);if(_68.negate)return!_23;else return _23};var _24=function(_65,_66,_46,_67,_68,_69){var _25;var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);var _17;if(_65===_17)return false;if(isc.isA.Date(_65)||isc.isA.Date(_7))return false;if(_68.caseInsensitive)_25=new RegExp(_65,"i");else _25=new RegExp(_65);return _25.test(_7)};var _26=function(_65,_66,_46,_67,_68,_69){var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);if(_65==null)_65=[]
else if(!isc.isAn.Array(_65))_65=[_65];if(!isc.isA.Date(_7)){var _27=_65.contains(_7)}else{_27=false;for(var i=0;i<_65.length;i++){if(isc.isA.Date(_65[i])&&_69.compareDates(_65[i],_7,_46)==0)
{_27=true;break}}}
if(_68.negate)return!_27;else return _27};var _29=function(_65,_66,_46,_67,_68,_69){if(_65==null)return true;var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);var _30=isc.DataSource.getPathValue(_66,_65);var _31=(_30==_7);if(isc.isA.Date(_30)&&isc.isA.Date(_7)){_31=(_69.compareDates(_30,_7,_46,_65)==0)}
if(_68.negate)return!_31;else return _31};var _32=function(_65,_66,_46,_67,_68,_69){if(_65==null)return true;var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);return _9(_7,_66,_46,_67,_68,_69)};var _33=function(_65,_66,_46,_67,_68,_69){if(_65==null)return true;var _6=_69.getField(_46);var _7=isc.DataSource.getPathValue(_66,_6?_6:_46);return _19(_7,_66,_46,_67,_68,_69)};var _34=function(_65,_66,_67,_68){if(!_66.criteria)_66.criteria=[];if(!isc.isAn.Array(_66.criteria)){isc.logWarn("AdvancedCriteria: boolean compareCriteria found "+"where old subcriteria was not an array");return-1}
...
var _35,_36=0,_37=_66.criteria.length,_38=_65.criteria.length;if(_38>_37&&_67.isOr){return-1}
var _39=isc.clone(_66.criteria);var _40=isc.clone(_65.criteria);for(var i=0;i<_37;i++){var _41=_39[i];var _42=i>_38?null:_40[i];if(!_42||(_42&&_42.fieldName!=_41.fieldName||_42.operator!=_41.operator||_42.processed==true)){_42=null;for(var j=0;j<_38;j++){if(_40[j].processed)continue;if(_40[j].fieldName==_41.fieldName&&_40[j].operator==_41.operator){_42=_40[j];break}}}
if(_42&&_41){_42.processed=true;_35=_68.compareAdvancedCriteria(_42,_41)}else{if(_41&&!_42){if(_67.isOr)_35=1;if(_67.isAnd)_35=-1;if(_67.isNot)_35=-1}}
if(_67.isAnd&&_35==-1)return-1;if(_67.isOr&&_35==-1)return-1;if(_67.isNot&&_35==1)return-1;if(_35!=0)_36=1}
for(var i=0;i<_38;i++){if(!_40[i].processed){if(_67.isOr)return-1;if(_67.isAnd)return 1;if(_67.isNot)return-1}}
return _36};var _44=function(_65,_66,_67,_68){if(_65.fieldName==_66.fieldName){var _8=_68.compareValues(_65.value,_66.value,_65.fieldName)==0;if(_8){return 0}else{return-1}}else{return-1}};var _45=function(_65,_66,_67,_68){var _46=_65.fieldName;if(_65.fieldName==_66.fieldName){if(_67.upperBounds&&_67.lowerBounds){if(_68.compareValues(_65.start,_66.start,_46)==0){if(_68.compareValues(_65.end,_66.end,_46)==0){return 0}}}else{if(_68.compareValues(_65.value,_66.value,_46)==0){return 0}}
var _47=_65.start==null?_65.value:_65.start,_48=_66.start==null?_66.value:_66.start,_49=_65.start==null?_65.value:_65.end,_50=_66.start==null?_66.value:_66.end;var _14,_51;var _52=true,_53=true,_54=true,_55=true;if(_48==null)_52=false;if(_50==null)_53=false;if(_47==null)_54=false;if(_49==null)_55=false;if(_67.lowerBounds&&!_67.upperBounds&&!_54&&!_52){return 0}
if(_67.lowerBounds&&!_67.upperBounds){if(_54&&!_52){return 1}
if(_52&&!_54){return-1}
var _56=_68.compareValues(_47,_48,_46);if(_56==-1){return 1}else if(_56==0){return 0}}
if(_67.upperBounds&&!_67.lowerBounds&&!_55&&!_53){return 0}
if(_67.upperBounds&&!_67.lowerBounds){if(_55&&!_53){return 1}
if(_53&&!_55){return-1}
var _56=_68.compareValues(_47,_48,_46);if(_56==1){return 1}else if(_56==0){return 0}}
if(_67.lowerBounds&&_67.upperBounds){if(_68.compareValues(_47,_48,_46)<=0&&_68.compareValues(_47,_50,_46)>=0&&_68.compareValues(_49,_50,_46)>=0&&_68.compareValues(_49,_48,_46)<=0)
{return 1}
if((_54&&!_52)||(_55&&!_53)){return 1}
if(!_54&&!_52&&!_55&&!_52){return 0}}}
return-1};var _57=function(_65,_66,_67){var _58=_66.value;var _59=_65.value;if(isc.isA.Number(_58))_58=""+_58;if(isc.isA.Number(_59))_59=""+_59;if(!isc.isA.String(_58)||!isc.isA.String(_59))return-1;if(_67.caseInsensitive){_58=_58.toLowerCase();_59=_59.toLowerCase()}
if(_65.fieldName==_66.fieldName&&_65.value==_66.value&&!_67.equals)
{return 0}
if(_67.equals){return _58==_59?0:-1}
if(_67.startsWith&&!_67.negate&&_59.length>_58.length&&isc.startsWith(_59,_58))
{return 1}
if(_67.startsWith&&_67.negate&&_58.length>_59.length&&isc.startsWith(_58,_59))
{return 1}
if(_67.endsWith&&!_67.negate&&_59.length>_58.length&&isc.endsWith(_59,_58))
{return 1}
if(_67.endsWith&&_67.negate&&_58.length>_59.length&&isc.endsWith(_58,_59))
{return 1}
if(!_67.startsWith&&!_67.endsWith&&!_67.negate&&_59.length>_58.length&&isc.contains(_59,_58))
{return 1}
if(!_67.startsWith&&!_67.endsWith&&_67.negate&&_58.length>_59.length&&isc.contains(_58,_59))
{return 1}
return-1};var _60=function(_65,_66,_67){if(_65.fieldName==_66.fieldName)return 0;else return-1};var _61=function(_65,_66,_67){if(_65.value==_66.value&&_65.fieldName==_66.fieldName){return 0}else{return-1}};var _62=function(_65,_66,_67){if(_65.fieldName==_66.fieldName){if(!isc.isAn.Array(_66.value)||!isc.isAn.Array(_65.value)){return-1}
...
return-1};var _63=function(_65,_66,_67){if(_65.value==_66.value&&_65.fieldName==_66.fieldName){return 0}else{return-1}};var _64=[{ID:"equals",titleProperty:"equalsTitle",negate:false,valueType:"fieldType",condition:_5,compareCriteria:_44,symbol:"==",wildCard:"*",canNormalize:true,getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"notEqual",titleProperty:"notEqualTitle",negate:true,valueType:"fieldType",condition:_5,compareCriteria:_44,symbol:"!",wildCard:"*",canNormalize:true,getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"greaterThan",titleProperty:"greaterThanTitle",lowerBounds:true,valueType:"fieldType",condition:_9,compareCriteria:_45,symbol:">",getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"lessThan",titleProperty:"lessThanTitle",upperBounds:true,valueType:"fieldType",condition:_9,compareCriteria:_45,symbol:"<",getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"greaterOrEqual",titleProperty:"greaterOrEqualTitle",lowerBounds:true,inclusive:true,valueType:"fieldType",condition:_9,compareCriteria:_45,symbol:">=",getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"lessOrEqual",titleProperty:"lessOrEqualTitle",upperBounds:true,inclusive:true,valueType:"fieldType",condition:_9,compareCriteria:_45,symbol:"<=",getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"between",titleProperty:"betweenTitle",lowerBounds:true,upperBounds:true,hidden:true,valueType:"valueRange",condition:_9,compareCriteria:_45,getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"iBetween",titleProperty:"iBetweenTitle",lowerBounds:true,upperBounds:true,hidden:true,valueType:"valueRange",condition:_9,caseInsensitive:true,compareCriteria:_45,getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"betweenInclusive",titleProperty:"betweenInclusiveTitle",lowerBounds:true,upperBounds:true,valueType:"valueRange",inclusive:true,condition:_9,compareCriteria:_45,symbol:"...",getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"iBetweenInclusive",titleProperty:"iBetweenInclusiveTitle",lowerBounds:true,upperBounds:true,valueType:"valueRange",inclusive:true,condition:_9,compareCriteria:_45,symbol:"...",caseInsensitive:true,getCriterion:function(_46,_65){var _21={fieldName:_46,operator:this.ID};if(isc.isA.RelativeDateItem(_65))
_21.value=_65.getRelativeDate()||_65.getValue();else _21.value=_65.getValue();return _21}},{ID:"iEquals",titleProperty:"iEqualsTitle",equals:true,caseInsensitive:true,valueType:"fieldType",condition:_19,symbol:"==",wildCard:"*",canNormalize:true,compareCriteria:_57},{ID:"iContains",titleProperty:"iContainsTitle",caseInsensitive:true,valueType:"fieldType",condition:_19,symbol:"~",canNormalize:true,compareCriteria:_57},{ID:"iStartsWith",titleProperty:"iStartsWithTitle",startsWith:true,caseInsensitive:true,valueType:"fieldType",condition:_19,symbol:"^",canNormalize:true,compareCriteria:_57},{ID:"iEndsWith",titleProperty:"iEndsWithTitle",endsWith:true,caseInsensitive:true,valueType:"fieldType",condition:_19,symbol:"|",canNormalize:true,compareCriteria:_57},{ID:"contains",titleProperty:"containsTitle",hidden:true,valueType:"fieldType",condition:_19,symbol:"~",canNormalize:true,compareCriteria:_57},{ID:"startsWith",titleProperty:"startsWithTitle",startsWith:true,hidden:true,valueType:"fieldType",condition:_19,symbol:"^",canNormalize:true,compareCriteria:_57},{ID:"endsWith",titleProperty:"endsWithTitle",endsWith:true,hidden:true,valueType:"fieldType",condition:_19,symbol:"|",canNormalize:true,compareCriteria:_57},{ID:"iNotEqual",titleProperty:"iNotEqualTitle",caseInsensitive:true,equals:true,negate:true,valueType:"fieldType",condition:_19,symbol:"!",wildCard:"*",canNormalize:true,compareCriteria:_57},{ID:"iNotContains",titleProperty:"iNotContainsTitle",caseInsensitive:true,negate:true,valueType:"fieldType",condition:_19,symbol:"!~",canNormalize:true,compareCriteria:_57},{ID:"iNotStartsWith",titleProperty:"iNotStartsWithTitle",startsWith:true,caseInsensitive:true,negate:true,valueType:"fieldType",condition:_19,symbol:"!^",canNormalize:true,compareCriteria:_57},{ID:"iNotEndsWith",titleProperty:"iNotEndsWithTitle",endsWith:true,caseInsensitive:true,negate:true,valueType:"fieldType",condition:_19,symbol:"!@",canNormalize:true,compareCriteria:_57},{ID:"notContains",titleProperty:"notContainsTitle",negate:true,hidden:true,valueType:"fieldType",condition:_19,symbol:"!~",canNormalize:true,compareCriteria:_57},{ID:"notStartsWith",titleProperty:"notStartsWithTitle",startsWith:true,negate:true,hidden:true,valueType:"fieldType",condition:_19,symbol:"!^",canNormalize:true,compareCriteria:_57},{ID:"notEndsWith",titleProperty:"notEndsWithTitle",endsWith:true,negate:true,hidden:true,valueType:"fieldType",condition:_19,symbol:"!@",canNormalize:true,compareCriteria:_57},{ID:"isNull",titleProperty:"isNullTitle",valueType:"none",condition:_22,symbol:"#",compareCriteria:_60},{ID:"notNull",titleProperty:"notNullTitle",negate:true,valueType:"none",condition:_22,symbol:"!#",compareCriteria:_60},{ID:"regexp",titleProperty:"regexpTitle",hidden:true,valueType:"custom",condition:_24,symbol:"/regex/",compareCriteria:_61},{ID:"iregexp",titleProperty:"iregexpTitle",hidden:true,caseInsensitive:true,valueType:"custom",condition:_24,symbol:"/regex/",compareCriteria:_61},{ID:"inSet",titleProperty:"inSetTitle",hidden:true,valueType:"valueSet",condition:_26,compareCriteria:_62,symbol:"=(",closingSymbol:")",valueSeparator:"|",processValue:function(_65,_66){return _65.split(this.valueSeparator)}},{ID:"notInSet",titleProperty:"notInSetTitle",negate:true,hidden:true,valueType:"valueSet",condition:_26,compareCriteria:_62,symbol:"!=(",closingSymbol:")",valueSeparator:"|",processValue:function(_65,_66){return _65.split(this.valueSeparator)}},{ID:"equalsField",titleProperty:"equalsFieldTitle",valueType:"fieldName",condition:_29,symbol:"=.",canNormalize:true,compareCriteria:_63,processValue:function(_65,_66){if(!_66)return _65;var _6=_66.getField(_65);if(_6)return _65;_6=_66.getFieldByTitle(_65);if(_6)return _6.name;return null}},{ID:"notEqualField",titleProperty:"notEqualFieldTitle",negate:true,valueType:"fieldName",condition:_29,canNormalize:true,compareCriteria:_63},{ID:"greaterThanField",titleProperty:"greaterThanFieldTitle",lowerBounds:true,valueType:"fieldName",condition:_32,compareCriteria:_63},{ID:"lessThanField",titleProperty:"lessThanFieldTitle",upperBounds:true,valueType:"fieldName",condition:_32,compareCriteria:_63},{ID:"greaterOrEqualField",titleProperty:"greaterOrEqualFieldTitle",lowerBounds:true,inclusive:true,valueType:"fieldName",condition:_32,compareCriteria:_63},{ID:"lessOrEqualField",titleProperty:"lessOrEqualFieldTitle",upperBounds:true,inclusive:true,valueType:"fieldName",condition:_32,compareCriteria:_63},{ID:"containsField",titleProperty:"containsFieldTitle",hidden:true,valueType:"fieldName",condition:_33,canNormalize:true,compareCriteria:_63},{ID:"startsWithField",titleProperty:"startsWithTitleField",startsWith:true,hidden:true,valueType:"fieldName",condition:_33,canNormalize:true,compareCriteria:_63},{ID:"endsWithField",titleProperty:"endsWithTitleField",endsWith:true,hidden:true,valueType:"fieldName",condition:_33,canNormalize:true,compareCriteria:_63},{ID:"and",titleProperty:"andTitle",isAnd:true,valueType:"criteria",condition:_1,symbol:" and ",compareCriteria:_34},{ID:"not",titleProperty:"notTitle",isNot:true,valueType:"criteria",condition:_1,compareCriteria:_34},{ID:"or",titleProperty:"orTitle",isOr:true,valueType:"criteria",condition:_1,symbol:" or ",compareCriteria:_34}];for(var _3=0;_3<_64.length;_3++){isc.DataSource.addSearchOperator(_64[_3])}
...
return _5}
,isc.A.$89n=function isc_c_RPCManager__stripRestTags(_1,_2){var _3=_2.jsonPrefix,_4=_2.jsonSuffix;var _5=_1.indexOf(_3);if(_5!=-1){return _1.substring(_5+_3.length,_1.lastIndexOf(_4))}
return _1}
...
var _3;if(_2.transport=="scriptInclude"){}else if(isc.isAn.Array(_2.results)){_3=true}else if(_2.allClientOnly){_2.results={status:0};_2.receiveTime=isc.timeStamp()}else{var _4=_2.operations[0];if(_4&&_4.isRestRequest){var _5=isc.DataSource.get(_4.dataSource);if(_5){var _6=_2.results?_2.results.indexOf(_5.jsonPrefix):-1;_3=_6!=-1;if(_3){var _7=_2.results;_7=this.$89n(_7,_5);try{_2.results=isc.eval("("+_7+")")}catch(e){this.logWarn("Error evaling REST RPC response: "+e+" response text: "+_7)}}}}
if(!_3){var _8=isc.isAn.Array(_2.operations)?_2.operations[0]:null;if(_8&&_8.isRestRequest&&_2.operations.length>1){if(_8.dataFormat=="json"){this.logWarn("Found a REST request that appears to be in JSON format, "+"but the response was not wrapped in start/end markers - aborting")
...
);isc.B._maxIndex=isc.C+71;isc.RPCManager.rpc_logMessage=isc.RPCManager.logMessage;isc.RPCManager.logMessage=function(_1,_2,_3,_4){if(this.logIsEnabledFor(_1,_3)){if(isc.isA.String(_2)&&_2.length>this.maxLogMessageLength&&!this.logIsEnabledFor(_1,"RPCManagerResponse"))
...
return _1}
,isc.A.getFieldValue=function isc_ResultSet_getFieldValue(_1,_2,_3,_4){if(this.dynamicDSFieldValues){return this.getDataSource().getFieldValue(_1,_2,_3)}else{return isc.Canvas.$70o(_3,_1,_4)}}
...
var _5=isc.addProperties({operation:this.getOperationId("fetch"),startRow:_2,endRow:_3,sortBy:isc.shallowClone(this.$39x),resultSet:this,clientContext:_4},this.context);if(this.progressiveLoading===true||this.progressiveLoading===false){_5.progressiveLoading=this.progressiveLoading}
...
if(_6){this.$10r(_5)}
for(var i=0;i<this.items.length;i++){var _10=this.items[i];if(isc.isAn.UploadItem(_10))continue;var _11=_10.dataPath||_10.name;if(_11==null)continue;var _12=isc.DynamicForm.$70o(_11,_4);if(this.fieldValuesAreEqual(_10,_12,_10.getValue())){if(_6){var _13=isc.DynamicForm.$70o(_11,_3);if(!this.fieldValuesAreEqual(_10,_12,_13)){_10.setValue(_13)}}}else{_7=false}}
...
isc.Validator.performAction(_25,_24,_5,_2,_23);if(!_25){_3=false;_23.addFieldErrors(_24.name,isc.Validator.getErrorMessage(_5),true)}else{if(_3==null)_3=true}}}
return _3}
...
);isc.B._maxIndex=isc.C+2;isc.defineClass("RestDataSource","DataSource");isc.A=isc.RestDataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.serverType="generic";isc.A.dataFormat="xml";isc.A.xmlRecordXPath="/response/data/*";isc.A.jsonRecordXPath="/response/data";isc.A.prettyPrintJSON=true;isc.A.dataFormatParamName="isc_dataFormat";isc.A.jsonPrefix="//isc_JSONResponseStart-->";isc.A.jsonSuffix="//isc_JSONResponseEnd";isc.A.operationBindings=[{operationType:"fetch",dataProtocol:"getParams"},{operationType:"add",dataProtocol:"postParams"},{operationType:"remove",dataProtocol:"postParams"},{operationType:"update",dataProtocol:"postParams"}];isc.A.sendMetaData=true;isc.A.metaDataPrefix="_";isc.B.push(isc.A.init=function isc_RestDataSource_init(){this.recordXPath=this.recordXPath||(this.dataFormat=="xml"?this.xmlRecordXPath:this.jsonRecordXPath);return this.Super("init",arguments)}
...
,isc.A.transformRequest=function isc_RestDataSource_transformRequest(_1){var _2=this.getDataProtocol(_1);_1.isRestRequest=!this.disableQueuing;_1.dataFormat=this.dataFormat;if(_2=="postMessage"){if(_1.params==null){_1.params={}}
...
,isc.A.buildValueItemList=function isc_FilterClause_buildValueItemList(_1,_2,_3){if(_2==null)this.logWarn("buildValueItemList passed null operator");var _4=_2?_2.valueType:"text",_5,_6,_7=[],_8,_9=null;if(_1==null){_5="text";_6=isc.SimpleType.getType(_5)}else{if(_3==null)_3=_1.name;_5=_1.type;_6=isc.SimpleType.getType(_1.type)||isc.SimpleType.getType("text")}
while(_6.inheritsFrom){_6=isc.SimpleType.getType(_6.inheritsFrom)}
_6=_6.name;_9=this.getEditorType(_1,_2.ID);if(_4=="fieldType"||_4=="custom"||_4=="valueSet"){var _10=_6;if(_4=="valueSet"){_9="TextAreaItem"}else if(_4=="custom"&&_2&&_2.editorType){_9=_2.editorType}
var _11=isc.addProperties({type:_10,name:_1?_1.name:null,showTitle:false,title:this.valueItemTitle,width:this.valueItemWidth,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_5,_3,_2.ID,"value"));if(_9)_11.editorType=_9;if(_4=="valueSet"){_11.multiple=true;_11.showHintInField=true;_11.hint=this.valueSetHint;_11.parseEditorValue=function(_17,_18,_19){if(_17==null)return _17;return _17.split(",")};_11.formatEditorValue=function(_17,_18,_19,_20){if(_17==null)return"";if(isc.isAn.Array(_17)){return _17.join(",")}
return _17}}
if(_1!=null&&_4!="custom"){_11=this.combineFieldData(_11,_1)}
_11.name="value";if(_5=="enum"){_11=isc.addProperties(_11,{valueMap:_1.valueMap})}
if(_6=="boolean"){_11=isc.addProperties(_11,{defaultValue:false})}
...
if(_1&&(_2=="equals"||_2=="notEqual"||_2=="lessThan"||_2=="greaterThan"||_2=="iBetween"||_2=="iBetweenInclusive"||_2=="between"||_2=="betweenInclusive"||_2=="greaterOrEqual"||_2=="lessOrEqual"))
...
,isc.A.getField=function isc_RuleEditor_getField(_1,_2){return this.dataSource?this.dataSource.getField(_1):isc.DataSource.getFieldFromDataSources(_1,this.dataSources,_2)}
...
return this.$896}
,isc.A.updateFieldName=function isc_RuleEditor_updateFieldName(_1,_2){this.fieldName=_1;this.locator=_2;var _3=_1!=null&&(!isc.isAn.Array(_1)||_1.length>0),_4=_2!=null&&(!isc.isAn.Array(_2)||_2.length>0),_5=(_3||_4)?this.getSupportedTypes(_1,_2):[],_6;if(this.validatorType!=null&&_5.length>0){_6=_5.contains(this.validatorType)}
...
if(isc.isAn.Array(_1))_1=_1[0];if(_1!=null&&this.validatorType!=null){this.valuesForm.fieldName=_1;this.valuesForm.clause.setValue("fieldName",_1);this.valuesForm.clause.setValue("operator",this.validatorType);var _7=this.getValidatorDefinition(this.validatorType);this.valuesForm.updateValueItems(this.valuesForm.getField(_1),_7,_1)}
...
var _4=this.fieldName;if(isc.isAn.Array(_4))_4=_4[0];if(this.valuesForm){var _5=_4?this.valuesForm.getField(_4):null;this.valuesForm.updateValueItems(_5,_2,_4);this.valuesForm.clause.setValue("operator",_1);return this.valuesForm}else{var _6=this.valuesForm=this.createAutoChild("valuesForm",{visibility:([this.fieldName||this.locator]?"inherit":"hidden"),showRemoveButton:false,dataSources:this.dataSources,dataSource:this.dataSource,fieldName:_4,operatorType:_1});var _7=_6.clause;_7.getItem("operator").hide();_7.getItem("operator").addUnknownValues=true;return _6}}
