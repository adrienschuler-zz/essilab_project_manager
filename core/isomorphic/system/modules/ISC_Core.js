 ...
 * Version SC_SNAPSHOT-2011-12-23 (2011-12-23)
...
var _4=this.sortProps,_5=this.normalizers,_6=this.contexts;var _7=isc.timestamp();for(var i=0;i<_4.length;i++){isc.$506[i]=this.sortDirections[i];var _8=_4[i],_9=_5[i],_10=_6[i];_1[i]=[];_2[i]=[];if(isc.isA.Function(_9)){for(var _11=0,l=this.length,_13;_11<l;_11++){_13=this[_11];if(_13==null){isc.$gq=true;continue}
...
if(_10&&_10.getField){var _19=_10.getField(_8);if(_19){if(_19.dataPath){_8=_19.dataPath;_18=true}else{_8=_19.name;_18=false}
...
var _24=false;for(var i=0;i<isc.$gi.length;i++){if(isc.$gi[i].length>0){_24=true;break}}
isc.$752=_24;var _25=isc.$gh,_26=isc.$506,_24=isc.$752;var _27=this;_27.compareAscending=Array.compareAscending;_27.compareDescending=Array.compareDescending;var _28=function(_37,_38){var _29=(_37!=null?_37.$gm:null),_30=(_38!=null?_38.$gm:null);for(var i=0;i<_25.length;i++){var _31=_25[i][_29],_32=_25[i][_30];if(_24&&_31!=null&&_32!=null){var _33=isc.$gi,_34=_33[i][_29],_35=_33[i][_30];if(_34!=null&&_35!=null){_31=_34;_32=_35}}
var _36=(_26[i]?_27.compareAscending(_31,_32):_27.compareDescending(_31,_32));if(_36!=0)return _36}
return 0};var _7=isc.timeStamp();this.sort(_28);if(isc.$gq){isc.Log.logWarn("Attempt to sort array by property hit null entry where a record should be. Array:"+isc.Log.echo(this));isc.$gq=null}
...
,isc.A.normalize=function isc_Arra_normalize(_1,_2){var _3=(_2.indexOf("/")>=0);var _4=null;var _5;if(isc.isA.String(this.normalizer)){var _6=this.$gj(_2);_4=isc.SimpleType.getType(_6);var _7=isc.SimpleType.getBaseType(_4);_5=this.$gk(_7)}else{_5=this.normalizer}
var _8=Array.$905(_1,_2,_3,_4);return _5[_8]}
);isc.B._maxIndex=isc.C+7;isc.A=Array;isc.A.$gt="$gu";isc.A.$gv="$gw";isc.A=Array;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$a6="string";isc.A.$gx="text";isc.A.$gy="number";isc.A.$gz="integer";isc.A.$g0="float";isc.A.$g1="int";isc.A.$g2="boolean";isc.A._$Date_="Date";isc.A.$g3="Time";isc.A.$68l="datetime";isc.A.$89w="Datetime";isc.A.$g4="date";isc.A.$g5="time";isc.A.$bl="object";isc.A.$g6={"float":"number","int:":"number","integer":"number","text":"string","Date":"date","Time":"date","time":"date"};isc.B.push(isc.A.$gl=function isc_Array__normalizeObj(_1){return _1}
,isc.A.$905=function isc_Array__getAtomicValue(_1,_2,_3,_4){var _5=null;if(_3){_5=isc.Canvas.$70o(_2,_1)}else{_5=_1[_2]}
if(_4&&_4.getAtomicValue){isc.Func.replaceWithMethod(_4,"getAtomicValue","value");_5=_4.getAtomicValue(_5)}
return _5}
,isc.A.$g7=function isc_Array__normalizeStr(_1){return(isc.isA.String(_1)?_1.toLowerCase():isc.emptyString)}
,isc.A.$g8=function isc_Array__normalizeNum(_1){return isc.isA.Number(_1)?_1:(0-Number.MAX_VALUE)}
,isc.A.$g9=function isc_Array__normalizeBool(_1){if(_1==true)return 1;if(_1==false)return 0;if(_1==null)return-1;return-2}
,isc.A.$ha=function isc_Array__normalizeDate(_1){var _2=(_1&&isc.isA.Date(_1)?_1.getTime():new Date(_1).getTime())
if(isNaN(_2))return-8640000000000000;return _2}
,isc.A.$hb=function isc_Array__normalizeTime(_1){if(!isc.isA.Date(_1)&&_1!=null)_1=isc.Time.parseInput(_1);if(isc.isA.Date(_1))return _1.getTime();return 0}
...
isc.ClassFactory.defineClass("Comm");isc.A=isc.Comm;isc.A.sendMethod="POST";isc.A.$hz=0;isc.A=isc.Comm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.xmlHttpConstructors=["MSXML2.XMLHTTP","Microsoft.XMLHTTP","MSXML.XMLHTTP","MSXML3.XMLHTTP"];isc.A.$50c=[];isc.B.push(isc.A.$h0=function isc_c_Comm__fireXMLCallback(_1,_2,_3){if(!_3)isc.EH.$h1("XRP");isc.Class.fireCallback(_2,"xmlHttpRequest",[_1],null,true);if(!_3)isc.EH.$h2()}
,isc.A.$h3=function isc_c_Comm__getStateChangeHandler(){return function(){var _1=arguments.callee.request;if(!_1)return;if(_1.readyState!=4)return;arguments.callee.request=null;isc.Timer.setTimeout({target:isc.Comm,methodName:"$h0",args:[_1,arguments.callee.callback,true]},0)}}
...
,isc.A.$h5=function isc_c_Comm__setHttpHeaders(_1,_2){if(_2==null)return;var _3=false;for(var _4 in _2){var _5=_2[_4];if(_5!=null){_1.setRequestHeader(_4,_5);if(_4.toLowerCase()=="content-type")_3=true}}
return _3}
...
if(_5!=false)_3.$85t[_3.$85t.length]=_4.keyName;_3.$885=_4.ctrlKey;_3.$886=_4.altKey;if(_5!=false&&_11){_5=_3.handleKeyPress(_1);_3.$85z[_4.keyName]=true}
if(_5==false){this.cancelKeyEvent(_1)}
return _5}
,isc.A.$90x=function isc_c_EventHandler__fireKeypressOnKeyDown(_1){var _2=isc.EH;return((isc.Browser.isMoz&&_1==this.$je&&this.shiftKeyDown())||(isc.Browser.isIE&&_2.$i8[_1]!=null)||(isc.Browser.isSafari&&_2.$90v[_1]!=null))}
...
);isc.B._maxIndex=isc.C+172;isc.EventHandler.captureEvents();isc.ClassFactory.defineClass("Element",null,null,true);isc.A=isc.Element;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$wq=window.isc_insertAfterBodyStart;isc.A.$wr="isc_global_insertion_marker";isc.A.$n7="afterBegin";isc.A.$n9="afterEnd";isc.A.$n6="beforeBegin";isc.A.$n8="beforeEnd";isc.A.$84e=(isc.Browser.isIE&&!isc.Browser.isIE9)||isc.Browser.isOpera;isc.A.$w2=isc.Browser.isMoz?"border-left-width":"borderLeftWidth";isc.A.$w3=isc.Browser.isMoz?"border-top-width":"borderTopWidth";isc.A.$oi=isc.Browser.isMoz?"margin-left":"marginLeft";isc.A.$ok=isc.Browser.isMoz?"margin-top":"marginTop";isc.A.$27r="none";isc.A.cacheCount=0;isc.A.uncachedCount=0;isc.A.$808="$808";isc.A.$809="$809";isc.A.cacheOffsetCoords=true;isc.A.$nk={};isc.A.$419={border:"borderStyle",borderWidth:"borderStyle",borderLeft:"borderLeftStyle",borderRight:"borderRightStyle",borderTop:"borderTopStyle",borderBottom:"borderBottomStyle",borderLeftWidth:"borderLeftStyle",borderRightWidth:"borderRightStyle",borderBottomWidth:"borderBottomStyle",borderTopWidth:"borderTopStyle"};isc.A.$nl={};isc.A.$39=";";isc.A.vendorCSSPrefix=(isc.Browser.isMoz?"-moz-":isc.Browser.isSafari?"-webkit-":isc.Browser.isOpera?"-o-":"");isc.B.push(isc.A.get=function isc_c_Element_get(_1,_2){_2=_2||this.getDocument();if(isc.Browser.isDOM)return _2.getElementById(_1)}
...
,isc.A.showRecursively=function isc_Canvas_showRecursively(){var _1=this.parentElement;if(this.$86x==null&&_1==null){this.show()}else{this.setVisibility(isc.Canvas.INHERIT);if(this.$86x!=null){_1=window[this.$86x]}
_1.showRecursively();if(isc.TabSet!=null&&isc.isA.TabSet(_1)){_1.selectTab(_1.tabForPane(this))}else if(isc.SectionStack!=null&&isc.isA.SectionStack(_1)){_1.expandSection(_1.sectionForItem(this))}}}
...
isc.ClassFactory.defineInterface("DataBoundComponent");isc.A=isc.Canvas;isc.A.COPY="copy";isc.A.MOVE="move";isc.A.CLONE="clone";isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$70l="/";isc.A.$605=".";isc.B.push(isc.A.getFieldImageDimensions=function isc_c_Canvas_getFieldImageDimensions(_1,_2){var _3,_4;var _5,_6,_7;if(isc.isA.String(_1.imageWidth)){_5=_1.imageWidth}else{_3=_1.imageWidth}
...
,isc.A.$833=function isc_c_Canvas__performActionOnValue(_1,_2,_3,_4,_5,_6,_7){if(!_3||_2==null||isc.isAn.emptyString(_2))return;var _8=_3;var _9=this.$70l;var _10=_2.contains(_9);if(!_10){_9=this.$605;_10=_2.contains(_9)}
if(_10){_2=_2.trim(_9);var _11=_2.split(_9),_12=[],_13;if(_11[0]&&_3[_11[0]]===_13&&_1=="get"&&!_7)
...
_12.add(_3);if(i==_11.length-1){if(_1=="get"){return _3[_11[i]]}else if(_1=="clear"){delete _3[_11[i]]}else if(_1=="save"){_3[_11[i]]=_6}}else{var _15=_3[_11[i]];if(_15==_13){if(_1=="get"){return _13}else if(_1=="clear"){return}else if(_1=="save"){_15=_3[_11[i]]={}}}
_3=_15;if(isc.isAn.Array(_3)){var _16=null;var _17=(parseInt(_11[i+1])==_11[i+1])
if(_17){_16=parseInt(_11[i+1])
_11.removeAt(i+1)}else if(_4&&_4.selectionComponent){var _18=_9,_19=_4,_20;for(var j=0;j<=i;j++){_18+=_11[j]+_9}
_18=_18.trim(_9);_19=_4.selectionComponent;while(_19){var _22=_19.dataPath;if(_22)_22=_22.trim(_9);if(_18==_22){var _23=_19.getSelectedRecord();if(_23){_16=_19.getRecordIndex(_23)}else{_20=true}
break}
_19=_19.selectionComponent}
if(_16==null){if(!_20&&_5){_16=0}else{return}}}else{if(_5){_16=0}else{return}}
_3=_3[_16]}}}
...
,isc.A.$70m=function isc_c_Canvas__clearFieldValue(_1,_2,_3,_4){if(isc.isAn.Object(_1)&&!isc.isA.Date(_1)&&_1.dataPath){var _5=_1.dataPath;if(_3){_1.dataPath=this.$840(_1.dataPath,_3)}
this.$833("clear",_1,_2,_3,_4,null,false);_1.dataPath=_5}else{this.$833("clear",_1,_2,_3,_4,null,false)}}
,isc.A.$70n=function isc_c_Canvas__saveFieldValue(_1,_2,_3,_4,_5){if(isc.isAn.Object(_1)&&!isc.isA.Date(_1)){if(_1.dataPath){var _6=_1.dataPath;if(_4){_6=this.$840(_1.dataPath,_4)}
this.$833("save",_6,_3,_4,_5,_2,false)}else if(_1.type){var _7=isc.SimpleType.getType(_1.type);if(_7&&_7.updateAtomicValue){isc.Func.replaceWithMethod(_7,"updateAtomicValue","value");_7.updateAtomicValue(_2,_3[_1.name])}else{this.$833("save",_1.name,_3,_4,_5,_2,false)}}else{this.$833("save",_1.name,_3,_4,_5,_2,false)}}else{this.$833("save",_1,_3,_4,_5,_2,false)}
return _3}
,isc.A.$70o=function isc_c_Canvas__getFieldValue(_1,_2,_3,_4){if(isc.isAn.Object(_1)&&!isc.isA.Date(_1)){if(_1.dataPath){var _5=_1.dataPath;if(_3){_5=this.$840(_1.dataPath,_3)}
var _6=this.$833("get",_5,_2,_3,_4,null,false);return _6}else if(_1.type){var _7=isc.SimpleType.getType(_1.type);if(_7&&_7.getAtomicValue){isc.Func.replaceWithMethod(_7,"getAtomicValue","value");return _7.getAtomicValue(_2[_1.name])}else{return this.$833("get",_1.name,_2,_3,_4,null,false)}}else{return this.$833("get",_1.name,_2,_3,_4,null,false)}}else{return this.$833("get",_1,_2,_3,_4,null,false)}}
,isc.A.$840=function isc_c_Canvas__trimDataPath(_1,_2){if(!_1)return _1;var _3=_1.trim(isc.Canvas.$70l);if(!_3.contains(isc.Canvas.$70l))return _1;var _4=_2.getFullDataPath();if(_4==null||_4=="")return _3;_4=_4.trim(isc.Canvas.$70l);var _5=_4.split(isc.Canvas.$70l);var _6=_3.split(isc.Canvas.$70l);for(var i=0;i<_5.length;i++){if(_5[i]!=_6[i]){break}}
...
,isc.A.shouldFilterLocalData=function isc_Canvas_shouldFilterLocalData(){if(this.filterLocalData!=null){return this.filterLocalData}else{return this.dataPath!=null}}
...
,isc.A.shouldSaveLocally=function isc_Canvas_shouldSaveLocally(){return(!this.dataSource||this.getFullDataPath()!=null||this.saveLocally||this.shouldFilterLocalData())}
...
var _6=this.data.get(_5.findByKeys(_2,this.data));isc.addProperties(_6,_2);return this.data.dataChanged()}else if(_1=="add"){if(this.originalData){this.originalData.add(_2);this.dataChanged("add",null,null,_2)}else{if(isc.isA.Tree(this.data)){var _7=this.data.getParent(_2)||this.data.getRoot();this.data.add(_2,_7)}else if(isc.ResultSet&&isc.isA.ResultSet(this.data)){if(this.data.allRows!=null){this.data.allRows.add(_2);this.data.filterLocalData()}else{isc.logWarn("Unable to add data to resultSet - allRows is not set")}}else{this.data.add(_2)}}
...
,isc.A.getHiliteIconLeftPadding=function isc_Canvas_getHiliteIconLeftPadding(_1){return(_1.hiliteIconLeftPadding!=null?_1.hiliteIconLeftPadding:this.hiliteIconLeftPadding||0)}
,isc.A.getHiliteIconRightPadding=function isc_Canvas_getHiliteIconRightPadding(_1){return(_1.hiliteIconRightPadding!=null?_1.hiliteIconRightPadding:this.hiliteIconRightPadding||0)}
,isc.A.getHiliteIconWidth=function isc_Canvas_getHiliteIconWidth(_1){return(_1.hiliteIconWidth!=null?_1.hiliteIconWidth:(_1.hiliteIconSize!=null?_1.hiliteIconSize:(this.hiliteIconWidth!=null?this.hiliteIconWidth:this.hiliteIconSize)))}
,isc.A.getHiliteIconHeight=function isc_Canvas_getHiliteIconHeight(_1){return(_1.hiliteIconHeight!=null?_1.hiliteIconHeight:(_1.hiliteIconSize!=null?_1.hiliteIconSize:(this.hiliteIconHeight!=null?this.hiliteIconHeight:this.hiliteIconSize)))}
,isc.A.getHiliteIconPosition=function isc_Canvas_getHiliteIconPosition(_1){return _1.hiliteIconPosition!=null?_1.hiliteIconPosition:this.hiliteIconPosition}
,isc.A.getHiliteIconHTML=function isc_Canvas_getHiliteIconHTML(_1,_2){var _3=_2.imageURLPrefix,_4=this.getHiliteIconWidth(_2),_5=this.getHiliteIconHeight(_2),_6=this.getHiliteIconLeftPadding(_2),_7=this.getHiliteIconRightPadding(_2);var _8=isc.Canvas.$xq(_1,_3,_4,_5,_6,_7,null,this);return _8}
...
);isc.evalBoundary;isc.B.push(isc.A.applyHiliteHTML=function isc_Canvas_applyHiliteHTML(_1,_2){if(!this.hilites)return _2;var _3,_4,_5;if(!isc.isAn.Array(_1)){this.$579[0]=_1;_1=this.$579}
...
return _2}
,isc.A.applyHiliteIcon=function isc_Canvas_applyHiliteIcon(_1,_2,_3){if(!this.hilites||!_2)return _3;var _4,_5,_6;if(!isc.isAn.Array(_1)){this.$579[0]=_1;_1=this.$579}
...
var _3=isc.DataSource.create({fields:_1});if(this.hiliteWindow){this.hiliteEditor.setDataSource(_3);this.hiliteEditor.clearHilites();this.hiliteEditor.setHilites(this.getHilites());this.hiliteEditor.setHiliteIcons(this.hiliteIcons);this.hiliteWindow.show();return}
var _4=this,_5=this.hiliteEditor=isc.HiliteEditor.create({autoDraw:false,dataSource:_3,hilites:this.getHilites(),hiliteIcons:this.hiliteIcons,callback:function(_7){if(_7!=null)_4.setHilites(_7);_4.hiliteWindow.hide()}}),_6=this.hiliteWindow=isc.Window.create({autoDraw:true,items:[_5],autoSize:true,autoCenter:true,isModal:true,showModalMask:true,closeClick:function(){this.hide()},title:"Edit Highlights",bodyProperties:{layoutMargin:8,membersMargin:8}});return _6}
...
,isc.A.setSort=function isc_Canvas_setSort(_1){this.$73p=isc.shallowClone(_1);if(this.data&&this.$73p&&this.$73p.length>0){for(var i=0;i<this.$73p.length;i++){var _3=this.$73p[i];if(!_3.context)_3.context=this}
if(this.data.setSort)this.data.setSort(this.$73p);else if(this.data.sortByProperty){var _3=this.$73p[0];this.data.sortByProperty(_3.property,Array.shouldSortAscending(_3.direction),_3.normalizer,_3.context)}}}
...
);isc.evalBoundary;isc.B.push(isc.A.$75e=function isc_Canvas__resolveStopOnError(_1,_2,_3){if(_1!=null)return _1;return(_2==null&&_3)||_2||false}
...
{_5=""}
return _5}
,isc.A.getObjectLocator=function isc_c_AutoTest_getObjectLocator(_1){var _2=this.$90w(_1);var _3=_2.getLocator();if(_2==_1){return _3}
var _4=_2.getObjectLocator(_1);if(_4!=null)_3+="/"+_4;return _3}
,isc.A.getLocatorObjectType=function isc_c_AutoTest_getLocatorObjectType(_1){var _2=_1.substring(_1.lastIndexOf("/")+1);if(_2&&_2.startsWith("objectType=")){return _2.substring(11)}
return"Canvas"}
...
,isc.A.getRelativeLocator=function isc_c_AutoTest_getRelativeLocator(_1,_2){var _3=this.locateCanvasFromDOMElement(_2),_4=this.getRelativeCanvasLocator(_1,_3)+"/"+_3.getInteriorLocator(_2);return _4}
,isc.A.isRelativeLocator=function isc_c_AutoTest_isRelativeLocator(_1){return(!_1.startsWith("//"))}
,isc.A.getRelativeCanvasLocator=function isc_c_AutoTest_getRelativeCanvasLocator(_1,_2){if(_1==_2)return"";var _3=_2,_4=[];while(_3!=_1){var _5=_3.getLocatorParent();if(_5==null){this.logWarn("Unexpected error: attempting to get relative locator from baseCompoenent:"+_1+" and target:"+_2+". Unable to determine "+"relationship between these objects.");return""}
var _6=_5.getChildLocator(_3);_4.add(_6);_3=_5}
var _7="";for(var i=_4.length-1;i>=0;i--){_7+=_4[i];if(i!=0)_7+="/"}
return _7}
,isc.A.getRelativeObjectLocator=function isc_c_AutoTest_getRelativeObjectLocator(_1,_2){var _3=this.$90w(_2);var _4=this.getRelativeCanvasLocator(_1,_3);if(_3==_2){return _4}
var _5=_3.getObjectLocator(_2);if(_5!=null)_4+="/"+_5;return _4}
,isc.A.$90w=function isc_c_AutoTest__getCanvasForSCObject(_1){if(_1.$75r!=null)_1=_1.$75r;if(_1.isSectionHeader){return _1.parentElement}
if(isc.FormItem&&isc.isA.FormItem(_1))return _1.form;if(isc.isA.Canvas(_1))return _1;this.logWarn("getRelativeLocatorObject() passed target object:"+this.echo(_1)+" This is not a recognized supported SmartClient object - expected to be a "+"Canvas, FormItem or SectionStackSection only");return null}
...
,isc.A.getObject=function isc_c_AutoTest_getObject(_1){if(!_1)return null;if(_1.startsWith("'")||_1.startsWith('"'))_1=_1.substring(1);if(_1.endsWith("'")||_1.endsWith('"'))_1=_1.substring(0,_1.length-1);if(!_1.startsWith("//")){if(_1.startsWith("ID=")||_1.startsWith("id=")){_1=_1.substring(3)}
_1='//*any*[ID="'+_1+'"]'}
var _2=_1.split("/"),_3;var _4=_2[2];if(!_4)return null;_2=_2.slice(3);var _5=this.getBaseComponentFromLocatorSubstring(_4);return this.resolveRelativeObjectLocator(_5,_2)}
,isc.A.resolveRelativeLocator=function isc_c_AutoTest_resolveRelativeLocator(_1,_2){var _3=_2.split("/");return _1.getElementFromSplitLocator(_3)}
,isc.A.resolveRelativeObjectLocator=function isc_c_AutoTest_resolveRelativeObjectLocator(_1,_2){var _3=isc.isAn.Array(_2)?_2:_2.split("/");return _1.getObjectFromSplitLocator(_3)}
...
);isc.B._maxIndex=isc.C+21;isc.ApplyAutoTestMethods=function(){isc.Canvas.addClassMethods({getCanvasLocatorFallbackPath:function Canvas_getCanvasLocatorFallbackPath(_9,_39,_164,_165,_166){if(_165==null)_165={};if(_166==null)_166={};else if(isc.isAn.Array(_166)){var _1={};for(var i=0;i<_166.length;i++){_1[_166[i]]=_166[i]}
_166=_1}
if(_166.title==null)_166.title="title";if(_166.scRole==null)_166.scRole="ariaRole";if(_166.name==null)_166.name="name";var _3=_39.getClassName(),_4=_39.getClass();_165.Class=_3;var _5;if(!_4.isFrameworkClass){_5=_4.$750}
if(_5!=null)_165.scClass=_5;if(_164!=null){_165.index=_164.indexOf(_39);_165.length=_164.length;var _6=_164.findAll("Class",_3);_165.classIndex=_6.indexOf(_39);_165.classLength=_6.length;if(_5!=null){var _7=_164.findAll("$75y",_5);_165.scClassIndex=_7.indexOf(_39);_165.scClassLength=_7.length}
if(_39.ariaRole!=null){var _8=_164.findAll("ariaRole",_39.ariaRole);_165.roleIndex=_8.indexOf(_39);_165.roleLength=_8.length}}
return isc.AutoTest.getObjectLocatorFallbackPath(_9,_39,_165,_166)},getCanvasFromFallbackLocator:function Canvas_getCanvasFromFallbackLocator(_164,_43,_44,_45,_46){var _9=_43.name;var _10=_43.Class,_5=_43.scClass||_43.Class,_11=_43.scRole;switch(_45){case"name":if(_9!=null){var _12=_44.find("name",_9);if(_12){switch(_46){case"Class":if(_10&&isc.isA[_10]&&isc.isA[_10](_12)){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_164+" - returning widget with matching name and ClassName:"+_12,"AutoTest")}
return _12}
case"scClass":if(_5&&isc.isA[_5]&&isc.isA[_5](_12))
{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_164+" - returning widget with matching name and scClassName:"+_12,"AutoTest")}
return _12}
case"role":var _13=_43.scRole;if(_12.ariaRole==_13){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_164+" - returning widget with matching name and role:"+_12,"AutoTest")}
return _12}
default:if(_46!="none"){isc.AutoTest.logRobustLocatorWarning();this.logWarn("Locator string:"+_164+". Returning closest match:"+_12+". This has the same name "+"as the recorded component but does not match class or role. ","AutoTest")}else{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_164+" - returning widget with matching name:"+_12,"AutoTest")}}
return _12}}}
...
_16=_17[0];if(_17.length==1&&_16){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_164+" - returning widget with matching name and scClassName:"+_16,"AutoTest")}
return _16}}}
case"role":if(_11){var _17=_15.findAll("ariaRole",_11);if(_17!=null){if(_17.length==1||_16==null)
_16=_17[0];if(_17.length==1&&_16){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_164+" - returning widget with matching title and role:"+_16,"AutoTest")}
return _16}}}
default:if(_15.length==1){if(_46!="none"){isc.AutoTest.logRobustLocatorWarning();this.logWarn("Locator string:"+_164+". Returning closest match:"+_15[0]+". This has the same title "+"as the recorded component but does not match class or role.","AutoTest")}else{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_164+" - returning widget with matching title:"+_16,"AutoTest")}}
return _15[0]}else{this.logWarn("Locator string:"+_164+", attempt to match by title failed -- multiple candidate components have this "+"same title. Attempting to match by index instead.","AutoTest")}}}}
default:var _18,_19,_20;switch(_46){case"Class":if(_10&&_43.classIndex){var _21=_44.findAll("Class",_10);if(_21&&_21.length>0){_18=_21[parseInt(_43.classIndex)];if(_21.length==parseInt(_43.classLength)){if(this.logIsInfoEnabled("AutoTest")){this.logInfo("Locator string:"+_164+" - returning widget with matching ClassName / index by ClassName:"+_18,"AutoTest")}
return _18}}}
...
return _19}}}
case"role":if(_11&&_43.roleIndex){var _23=_44.findAll("ariaRole",_11);if(_23&&_23.length>0){_20=_23[parseInt(_43.roleIndex)];if(_23.length==parseInt(_43.roleLength)){if(this.logIsInfoEnabled("AutoTest")){this.logInfo("Locator string:"+_164+" - returning widget with matching role / index by role:"+_20,"AutoTest")}
return _20}}}
...
if(_24){this.logWarn("Locator string:"+_164+" matching by index gave "+_24+". Reliability cannot be guaranteed for matching by index if the underlying "+"application undergoes any changes.","AutoTest");return _24}}}
this.logDebug("AutoTest.getElement(): locator substring:"+_164+" parsed to fallback locator name:"+_9+", unable to find relevant child - may refer to inner element.","AutoTest")}});isc.Canvas.addMethods({getLocator:function canvas_getLocator(_50,_164){var _26,_27;if(this._generated||this.locatorParent||this.creator||this.$541){_27=this.getLocatorParent()}
if(!_27){_26=this.getLocatorRoot()}else{_26=_27.getLocator()+"/"+_27.getChildLocator(this)}
if(_50)return[_26,this.getInteriorLocator(_50,_164)].join("/");return _26},getObjectLocator:function canvas_getObjectLocator(_164){},getObjectFromSplitLocator:function canvas_getObjectFromSplitLocator(_164){var _28=this.getChildFromLocatorSubstring(_164[0],0,_164);if(_28!=null){_164.removeAt(0);return _28.getObjectFromSplitLocator(_164)}
return this},$549:["//",,'[ID="',,'"]'],getLocatorRoot:function canvas_getLocatorRoot(){if(!this.locatorRoot){if(this.$541&&this.parentElement==null){this.locatorRoot="//"+isc.Canvas.getCanvasLocatorFallbackPath("autoID",this,isc.Canvas.$tw)}else{this.$549[1]=this.getClassName();this.$549[3]=this.getID();this.locatorRoot=this.$549.join(isc.emptyString)}}
return this.locatorRoot},containsLocatorChild:function canvas_containsLocatorChild(_39){if(this.namedLocatorChildren!=null){for(var i=0;i<this.namedLocatorChildren.length;i++){var _9=this.namedLocatorChildren[i];if(isc.isAn.Object(_9))_9=_9.attribute;if(_39==this[_9]){return true}}}
...
if(this.creator&&(isc.isA.Canvas(this.creator)||isc.isA.FormItem(this.creator))){var _29=this.creator.getAutoChildLocator(this);if(_29==null){this.logInfo("Locator code failed to find relationship between parent:"+this.creator.getID()+" and autoChild:"+this.getID(),"AutoTest")}else{return this.creator}}
return this.masterElement||this.parentElement},$55a:[,"[",,'][Class="',,'"]'],getChildLocator:function canvas_getChildLocator(_39){if(_39==this.hscrollbar){return"hscrollbar"}
if(_39==this.vscrollbar){return"vscrollbar"}
if(_39.creator==this){var _30=this.getAutoChildLocator(_39);if(_30)return _30}
return this.getStandardChildLocator(_39)},checkLocatorForNativeElement:function canvas_checkLocatorForNativeElement(_68,_50){if(_50==null||_68==null)return false;return(isc.EventHandler.eventHandledNatively("mousedown",_50,true)&&(isc.AutoTest.getElement(_68)!=_50))},getCanvasLocatorFallbackPath:function canvas_getCanvasLocatorFallbackpath(_9,_39,_164,_165,_166){return isc.Canvas.getCanvasLocatorFallbackPath(_9,_39,_164,_165,_166)},getAutoChildLocator:function canvas_getAutoChildLocator(_39){if(this.$542){var _31=_39.getID();for(var _32 in this.$542){var _33=this.$542[_32];if(_33.contains(_31)){if(_39==this[_32])return _32;else{var _34=[];for(var i=0;i<_33.length;i++){_34[i]=window[_33[i]]}
return this.getCanvasLocatorFallbackPath(_32,_39,_34)}}}}
return null},getNamedLocatorChildString:function canvas_getNamedLocatorChildString(_39){if(_39.locatorParent==this&&this.namedLocatorChildren){for(var i=0;i<this.namedLocatorChildren.length;i++){var _9=this.namedLocatorChildren[i],_35=_9;if(isc.isA.Object(_9)){_35=_9.attribute,_9=_9.name}
if(_39==this[_35]){return _9}}}},getStandardChildLocator:function canvas_getStandardChildLocator(_39){var _36=this.getNamedLocatorChildString(_39);if(_36)return _36;if(_39.masterElement==this){return this.getCanvasLocatorFallbackPath("peer",_39,this.peers)}else if(_39.parentElement==this){return this.getCanvasLocatorFallbackPath("child",_39,this.children)}else{this.logWarn("unexpected error - failed to find relationship between parent:"+this.getID()+" and child:"+_39.getID());return _39.getLocatorRoot()}},getInteriorLocator:function canvas_getInteriorLocator(_50,_164){if(_50&&this.useEventParts){var _37=this.getElementPart(_50);if(_37!=null&&_37.part!=null){return(_37.partID&&_37.partID!=isc.emptyString)?_37.part+"_"+_37.partID:_37.part}}
return isc.emptyString},getElementFromSplitLocator:function canvas_getElementFromSplitLocator(_164){var _28=this.getChildFromLocatorSubstring(_164[0],0,_164);if(_28){_164.removeAt(0);return _28.getElementFromSplitLocator(_164)}
return this.getInnerElementFromSplitLocator(_164)},getChildFromLocatorSubstring:function canvas_getChildFromLocatorSubstring(_164,_25,_165){if(_164==null||_164=="")return null;if(isc.isA.Canvas(this[_164])){return this[_164]}
if(this.namedLocatorChildren!=null){var _38=this.namedLocatorChildren.find("name",_164);if(_38!=null){var _39=this[_38.attribute];if(isc.isA.Canvas(_39))return _39;this.logWarn("Locator substring:"+_164+" remaps to attribute:"+_38.attribute+" but no canvas exists under that attribute name.","AutoTest")}}
var _40=isc.AutoTest.parseLocatorFallbackPath(_164);if(_40!=null){return this.getChildFromFallbackLocator(_164,_40)}
return null},getChildLocatorStrategy:function canvas_getChildLocatorStrategy(_164){if(isc.AutoTest.locStrategyNames==null){isc.AutoTest.locStrategyNames={}}
var _35=isc.AutoTest.locStrategyNames[_164];if(_35==null){var _41=_164;if(isc.isA.String(this.$558[_164]))_41=this.$558[_164];_35=isc.AutoTest.locStrategyNames[_164]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"By"}
return this[_35]},getChildLocatorTypeStrategy:function canvas_getChildLocatorTypeStrategy(_164){if(isc.AutoTest.locStrategyTypes==null){isc.AutoTest.locStrategyTypes={}}
var _35=isc.AutoTest.locStrategyTypes[_164];if(_35==null){var _41=_164;if(isc.isA.String(this.$558[_164]))_41=this.$558[_164];_35=isc.AutoTest.locStrategyTypes[_164]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"Type"}
return this[_35]},getChildFromFallbackLocator:function canvas_getChildFromFallbackLocator(_164,_40){var _42=_40.name,_43=_40.config;var _44=this.getFallbackLocatorCandidates(_42);if(_44&&_44.length>0){var _45=this.getChildLocatorStrategy(_42);if(_45==null)_45="name";var _46=this.getChildLocatorTypeStrategy(_42);if(_46==null)_46="Class";var _24=isc.Canvas.getCanvasFromFallbackLocator(_164,_43,_44,_45,_46);if(_24!=null)return _24}
this.logDebug("AutoTest.getElement(): locator substring:"+_164+" parsed to fallback locator name:"+_42+", unable to find relevant child - may refer to inner element.","AutoTest")},$558:{peer:"peers",child:"children"},getFallbackLocatorCandidates:function canvas_getFallbackLocatorCandidates(_9){var _44;if(this.$542!=null&&this.$542[_9]!=null){var _47=this.$542[_9];_44=[];for(var i=0;i<_47.length;i++){_44[i]=window[_47[i]]}}else if(isc.isA.String(this.$558[_9])){_44=this[this.$558[_9]]}else if(this[_9]&&isc.isAn.Array(this[_9])){_44=this[_9]}
return _44},emptyLocatorArray:function canvas_emptyLocatorArray(_164){return _164==null||_164.length==0||(_164.length==1&&_164[0]=="")},getInnerElementFromSplitLocator:function canvas_getInnerElementFromSplitLocator(_164){if(!this.emptyLocatorArray(_164)){if(_164.length==1){var _48=_164[0].split("_");var _49={part:_48[0],partID:_48[1]};var _50=this.getPartElement(_49);if(_50)return _50}}
return this.getHandle()},getAutoTestLocatorCoords:function canvas_getAutoTestLocatorCoords(_68,_50){if(_68==null||_50==null)return null;var _51=isc.Element.getElementRect(_50);var _52=_51[0],_53=_51[2];_52+=Math.floor(_53/ 2);var _54=_51[1],_55=_51[3];_54+=Math.floor(_55/ 2);return[_52,_54]}});if(isc.Layout){isc.Layout.addProperties({getStandardChildLocator:function canvas_getStandardChildLocator(_39){var _36=this.getNamedLocatorChildString(_39);if(_36)return _36;if(this.members.contains(_39)){return this.getCanvasLocatorFallbackPath("member",_39,this.members)}
return this.Super("getStandardChildLocator",arguments)},$558:{member:"members",peer:"peers",child:"children"}})}
if(isc.Window){isc.Window.addProperties({containsLocatorChild:function window_containsLocatorChild(_39){if(this.items&&this.items.contains(_39))return true;return this.Super("containsLocatorChild",arguments)},getStandardChildLocator:function window_getStandardChildLocator(_39){if(this.items&&this.items.contains(_39)){var _56=this.$55a;_56[0]="item";_56[2]=this.items.indexOf(_39);_56[4]=_39.getClassName();return _56.join(isc.emptyString)}
return this.invokeSuper(isc.Window,"getStandardChildLocator",_39)},$558:{item:"items",member:"members",peer:"peers",child:"children"}})}
if(isc.SectionStack){isc.ImgSectionHeader.changeDefaults("$558",{item:"items"});isc.SectionHeader.changeDefaults("$558",{item:"items"});isc.SectionStack.changeDefaults("$558",{section:"sections"});isc.SectionStack.addProperties({getObjectLocator:function sectionStack_getObjectLocator(_164){if(_164.getSectionHeader)_164=_164.getSectionHeader();if(_164.isSectionHeader){var _57=this.getStandardChildLocator(_164);_57+="/objectType=Section";return _57}
return this.Super("getObjectLocator",arguments)},getStandardChildLocator:function sectionStack_getStandardChildLocator(_39){var _58=this.sections||[],_59;for(var i=0;i<_58.length;i++){var _60=_58[i].items,_61,_62;if(_39==_58[i]){_61=_39}else if(_60&&_60.contains(_39)){_61=_58[i];_62=_39}
if(_61!=null){_59=this.getCanvasLocatorFallbackPath("section",_61,this.sections)}
if(_62!=null){_59+="/"+this.getCanvasLocatorFallbackPath("item",_62,_61.items)}
if(_59!=null)return _59}
return this.Super("getStandardChildLocator",arguments)}})}
if(isc.StretchImg){isc.StretchImg.addProperties({getInteriorLocator:function stretchImg_getInteriorLocator(_50,_164){var _63=_50,_64=this.getHandle(),_65=this.getCanvasName();while(_50&&_50!=_64&&_50.getAttribute){var _31=_50.getAttribute("name");if(_31&&_31.startsWith(_65)){return _31.substring(_65.length)}
_50=_50.parentNode}
return this.Super("getInteriorLocator",[_63,_164])},getInnerElementFromSplitLocator:function stretchImg_getInnerElementFromSplitLocator(_164){if(!this.emptyLocatorArray(_164)&&_164.length==1){var _66=this.getImage(_164[0]);if(_66)return _66}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.DynamicForm){isc.DynamicForm.addProperties({getInteriorLocator:function dynamicForm_getInteriorLocator(_50){var _67=isc.DynamicForm.$mu(_50,this);if(!_67.item)return this.Super("getInteriorLocator",arguments);var _62=_67.item,_68=[this.getItemLocator(_62),'/'];if(_67.overElement)_68[_68.length]="element";else if(_67.overTitle)_68[_68.length]="title";else if(_67.overTextBox)_68[_68.length]="textbox";else if(_67.overControlTable)_68[_68.length]="controltable";else if(_67.overIcon)_68[_68.length]="[icon='"+_67.overIcon+"']"
return _68.join(isc.emptyString)},getItemLocator:function dynamicForm_getItemLocator(_62){if(_62.parentItem&&(_62.parentItem!=this)){return this.getItemLocator(_62.parentItem)+"/"+_62.parentItem.getItemLocator(_62)}
var _69={};if(_62.name!=null)_69.name=_62.name;var _14=_62.getTitle();if(_14!=null)_69.title=_14;var _70=_62.getValue();if(_70!=null)_69.value=_70;_69.index=this.getItems().indexOf(_62);_69.Class=_62.getClassName();var _71=isc.AutoTest.createLocatorFallbackPath("item",_69);return _71},getObjectLocator:function dynamicForm_getObjectLocator(_164){if(isc.isA.FormItem(_164)){var _72=this.getItemLocator(_164);_72+="/objectType=FormItem";return _72}
return this.Super("getObjectLocator",arguments)},getObjectFromSplitLocator:function dynamicForm_getObjectFromSplitLocator(_164){var _28=this.Super("getObjectFromSplitLocator",arguments);if(_28!=this)return _28;if(_164.length>0){var _62=this.getItemFromSplitLocator(_164);if(_62!=null){_164.removeAt(0);return _62.getObjectFromSplitLocator(_164)}}
return this},containsLocatorChild:function dynamicForm_containsLocatorChild(_39){if(isc.isA.DateChooser(_39)&&_39.callingForm==this)return true;return this.Super("containsLocatorChild",arguments)},getChildLocator:function dynamicForm_getChildLocator(_39){if(_39.canvasItem){var _62=_39.canvasItem;return this.getItemLocator(_62)+"/canvas"}
if(isc.isA.PickListMenu(_39)){var _62=_39.formItem;return this.getItemLocator(_62)+"/pickList"}
if(isc.isA.DateChooser(_39)){var _62=_39.callingFormItem;return this.getItemLocator(_62)+"/picker"}
return this.Super("getChildLocator",arguments)},getItemFromSplitLocator:function dynamicForm_getItemFromSplitLocator(_164){var _73=_164[0],_10;if(_73.contains("[Class=")){var _74=_73.match("item\\[(.+)'\\]\\[Class=\"(.+)\"\\]");_10=_74[1].substring(6,_74[1].length-2);_73=_74[0]}
var _75=isc.AutoTest.parseLocatorFallbackPath(_73);if(_75&&_75.name=="item"&&_75.config!=null){var _43=_75.config;_10=_43.Class;var _62;if(_43.name!=null){_62=this.getItem(_43.name)}else{for(var i=0;i<this.items.length;i++){var _76=this.items[i],_77=_76.locateItemBy;if(_77==null)_77="title";if(_77=="title"&&_43.title!=null&&_76.title==_43.title)
{_62=_76}else if(_77=="value"&&_43.value!=null&&_76.getValue()==_43.value)
{_62=_76}}
if(_62==null){var _25=_43.index;if(isc.isA.String(_25)){if(_25.startsWith("'")||_25.startsWith('"'))
{_25=_25.substring(1)}
_25=parseInt(_25)}
_62=this.items[_25]}}
if(!_62){this.logWarn("AutoTest.getElement(): Unable to find item from "+"locator string:"+_73);return null}
if(!isc.isA[_10]||!isc.isA[_10](_62)){this.logWarn("AutoTest.getElement(): identifier:"+_73+" returned an item of class:"+_62.getClassName())}
return _62}
return null},getInnerElementFromSplitLocator:function dynamicForm_getInnerElementFromSplitLocator(_164){if(this.emptyLocatorArray(_164)){return this.getHandle()}
var _62=this.getItemFromSplitLocator(_164);if(_62!=null){_164.removeAt(0);return _62.getInnerElementFromSplitLocator(_164)}
return this.getHandle()}});isc.ContainerItem.addProperties({getItemLocator:isc.DynamicForm.getPrototype().getItemLocator,getItemFromSplitLocator:isc.DynamicForm.getPrototype().getItemFromSplitLocator,getInnerElementFromSplitLocator:function(_164){if(!this.emptyLocatorArray(_164)){var _78=this.getItemFromSplitLocator(_164);if(_78!=null){_164.removeAt(0);return _78.getInnerElementFromSplitLocator(_164)}}
return this.Super("getInnerElementFromSplitLocator",arguments)}});isc.FormItem.addProperties({getChildLocator:function formItem_getChildLocator(_164){if(_164.creator==this){var _30=this.getAutoChildLocator(_164);if(_30)return _30}},getAutoChildLocator:isc.Canvas.getPrototype().getAutoChildLocator,getLocator:function formItem_getLocator(){var _79=this.form;return _79.getLocator()+"/"+_79.getItemLocator(this)},getElementFromSplitLocator:function formItem_getElementFromSplitLocator(_164){return this.getInnerElementFromSplitLocator(_164)},getObjectFromSplitLocator:function formItem_getObjectFromSplitLocator(_164){if(_164.length>0){var _49=_164[0];if(_49=="canvas"&&this.canvas){_164.removeAt(0);return this.canvas.getObjectFromSplitLocator(_164)}else if(this.getItemFromSplitLocator){var _78=this.getItemFromSplitLocator(_164);if(_78&&_78!=this){_164.removeAt(0);return _78.getObjectFromSplitLocator(_164)}}else{var _80=this.$903(_49);if(_80){_164.removeAt(0);return _80.getObjectFromSplitLocator(_164)}}}
return this},getInnerElementFromSplitLocator:function formItem_getInnerElementFromSplitLocator(_164){if(!this.emptyLocatorArray(_164)){var _49=_164[0];if(_49=="element")return this.getDataElement();if(_49=="title")return this.form.getTitleCell(this);if(_49=="textbox")return this.$15h();if(_49=="controltable")return this.$56a();if(_49=="canvas"){if(this.canvas){_164.removeAt(0);return this.canvas.getElementFromSplitLocator(_164)}}
if(_49=="picker"){if(this.picker){_164.removeAt(0);return this.picker.getElementFromSplitLocator(_164)}}
if(_49=="pickList"){if(!this.pickList)this.makePickList(false);_164.removeAt(0);return this.pickList.getElementFromSplitLocator(_164)}
var _81=_49.match("\\[icon='(.+)'\\]"),_82=_81?_81[1]:null;if(_82){return this.$16v(_82)}
if(this.$542){var _83=this.$903(_49);if(_83){_164.removeAt(0);return _83.getElementFromSplitLocator(_164)}}}else{var _50=this.getFocusElement();if(_50==null)_50=this.$15h();return _50}},$903:function(_9){var _83;var _33=this.$542?this.$542[_9]:null;if(_33&&_33.length>0){if(this[_9]!=null)_83=this[_9];else{}}
if(_83)return _83},emptyLocatorArray:isc.Canvas.getPrototype().emptyLocatorArray});isc.HeaderItem.addProperties({locateItemBy:"value"});if(isc.PickListMenu){isc.PickListMenu.addProperties({getLocatorParent:function pickListMenu_getLocatorParent(){if(this.formItem)return this.formItem.form;return this.Super("getLocatorParent",arguments)}})}}
if(isc.GridRenderer){isc.GridRenderer.addProperties({getInteriorLocator:function gridRenderer_getInteriorLocator(_50,_164){var _84=this.getCellFromDomElement(_50);if(_84==null)return this.Super("getInteriorLocator",[_50,_164]);var _85=_84[0],_86=_84[1];return this.getCellLocator(_85,_86)},getCellFromDomElement:function gridRenderer_getCellFromDomElement(_50){var _64=this.getHandle(),_87=this.getTableElement();if(!_87)return null;var _88=_87.rows,_89,_90,_84,_91="tr",_92="TR",_93="td",_94="TD";while(_50&&_50!=_87&&_50!=_64){_89=_50.tagName;if(_89==_93||_89==_94){_84=_50}
if(_89==_91||_89==_92){_90=_50}
_50=_50.parentNode}
if(!_90||!_84)return null;var _88=_87.rows,_85,_95;for(var i=0;i<_88.length;i++){if(_88[i]==_90){_85=i;break}}
var _96=_90.cells,_86,_97;for(var i=0;i<_96.length;i++){if(_96[i]==_84){_86=i;break}}
_95=_85+(this.$252||0);_97=_86+(this.$254||0);return[_95,_97]},getCellLocator:function gridRenderer_getCellLocator(_85,_86){return"row["+_85+"]/col["+_86+"]"},getInnerElementFromSplitLocator:function gridRenderer_getInnerElementFromSplitLocator(_164){if(this.emptyLocatorArray(_164))return this.getHandle();if(_164.length==2){var _84=this.getCellFromLocator(_164[0],_164[1]),_85=_84[0],_86=_84[1];if(isc.isA.Number(_85)&&isc.isA.Number(_86)){if(this.$29p())return null;return this.getTableElement(_85,_86)}}
return this.Super("getInnerElementFromSplitLocator",arguments)},getCellFromLocator:function gridRenderer_getCellFromLocator(_116,_113){var _98=_116.substring(4,_116.length-1),_99=_113.substring(4,_113.length-1);return[_85,_86]}})}
if(isc.ListGrid){isc.ListGrid.addProperties({namedLocatorChildren:["header","frozenHeader","body","frozenBody",{attribute:"$286",name:"editRowForm"}]});isc.GridBody.addProperties({getInteriorLocator:function gridBody_getInteriorLocator(_50,_164){if(_164){var _33=this.children;if(_33!=null&&_33.length>0){for(var i=0;i<_33.length;i++){var _28=_33[i];if(_28&&_28.eventProxy==this){var _64=_28.getHandle();if(_64!=null){var _100=_50;while(_100!=this.getHandle()&&_100!=null)
{if(_100==_64){var _85=this.getEventRow(),_86=this.getEventColumn();return this.getCellLocator(_85,_86)}
_100=_100.parentNode}}}}}}
return this.Super("getInteriorLocator",arguments)},getCellLocator:function gridBody_getCellLocator(_85,_86){var _101=this.grid;if(_101==null)return this.Super("getCellLocator",arguments);return _101.getCellLocator(this,_85,_86)}});isc.ListGrid.addProperties({getCellLocator:function listGrid_getCellLocator(_112,_85,_86){var _102=this.getRowLocatorOptions(_112,_85,_86),_103=this.getColLocatorOptions(_112,_85,_86);return isc.AutoTest.createLocatorFallbackPath("row",_102)+"/"+isc.AutoTest.createLocatorFallbackPath("col",_103)},getRowLocatorOptions:function listGrid_getRowLocatorOptions(_112,_85,_86){var _104={},_105=this.getFieldNumFromLocal(_86,_112),_106=this.getCellRecord(_85,_105),_107=this.getDataSource();if(_106!=null){if(_107!=null){var _108=_107.getPrimaryKeyFieldName();if(_108!=null&&_106[_108]!=null){_104[_108]=_106[_108]}}
var _109=this.getTitleField();if(_109!=null&&_106[_109]!=null){_104[_109]=_106[_109]}
var _110=this.getFieldName(_105);if(_110!=null&&_106[_110]!=null){_104[_110]=_106[_110]}}
_104[isc.AutoTest.fallback_valueOnlyField]=_85;return _104},getColLocatorOptions:function listGrid_getColLocatorOptions(_112,_85,_86){var _104={},_105=this.getFieldNumFromLocal(_86,_112);var _111=this.getField(_105);if(this.isCheckboxField(_111)){_104.isCheckboxField=true}else{var _110=this.getFieldName(_105);if(_110!=null)_104.fieldName=_110}
_104[isc.AutoTest.fallback_valueOnlyField]=_86;return _104},getChildFromLocatorSubstring:function listGrid_getChildFromLocatorSubstring(_164,_25,_165){if(_164=="frozenBody"||_164=="body"){if(_165.length==_25+3&&_165[_25+1].startsWith("row[")&&_165[_25+2].startsWith("col["))
{return null}}
return this.Super("getChildFromLocatorSubstring",arguments)},getInnerElementFromSplitLocator:function listGrid_getInnerElementFromSplitLocator(_164){if(this.emptyLocatorArray(_164))return this.getHandle();var _112=_164[0];if(_164.length==3&&(_112=="body"||_112=="frozenBody")){var _113=_164[2],_114=isc.AutoTest.parseLocatorFallbackPath(_113);if(_114.name!="col"){this.logWarn("Error parsing locator:"+_164.join("")+" returning ListGrid handle");return this.getHandle()}
var _111=this.getFieldFromColLocatorConfig(_114.config),_115;if(_111==null){_115=parseInt(_114.config[isc.AutoTest.fallback_valueOnlyField]);if(_112=="frozenBody"&&this.frozenBody==null){_112="body"}
_112=this[_112]}else{_115=this.getLocalFieldNum(this.getFieldNum(_111));if(this.fieldIsFrozen(_111))_112=this.frozenBody;else _112=this.body}
if(_112==null)return null;var _116=_164[1],_117=isc.AutoTest.parseLocatorFallbackPath(_116),_85=this.getRowNumFromLocatorConfig(_117.config);if(isc.isA.Number(_85)&&isc.isA.Number(_115)){if(_112.$29p())return null;return _112.getTableElement(_85,_115)}}
return this.Super("getInnerElementFromSplitLocator",arguments)},getFieldFromColLocatorConfig:function listGrid_getFieldFromColLocatorConfig(_164){if(_164.isCheckboxField!=null){for(var i=0;i<this.fields.length;i++){if(this.isCheckboxField(this.fields[i])){return this.fields[i]}
this.logWarn("AutoTest stored a locator for interaction with "+"checkbox field - but this grid is not showing a checkbox field - "+"recorded test may be invalid.","AutoTest");return-1}}else{var _118=this.locateColumnsBy;if(_118=="fieldName"||_118==null){var _110=_164.fieldName;if(_110!=null){return this.getField(_110)}}}},getRowNumFromLocatorConfig:function listGrid_getRowNumFromLocatorConfig(_164){var _119=this.locateRowsBy;if(_119==null)_119="primaryKey";switch(_119){case"primaryKey":var _107=this.getDataSource();if(_107!=null){var _120=_107.getPrimaryKeyFieldName();if(_107!=null&&_164[_120]!=null){return this.findRowNum(_164)}}
case"titleField":var _109=this.getTitleField();if(_109!=null&&_164[_109]!=null){var _121=this.data;return _121.findIndex(_109,_164[_109])}
case"targetCellValue":for(var _110 in _164){if(_110==isc.AutoTest.fallback_valueOnlyField)continue;if(_164[_110]!=null){return this.data.findIndex(_110,_164[_110])}}
default:return parseInt(_164[isc.AutoTest.fallback_valueOnlyField])}}})}
if(isc.TreeGrid){isc.TreeGridBody.addProperties({getInteriorLocator:function treeGrid_getInteriorLocator(_50){var _63=_50;var _64=this.getHandle(),_122=this.getTableElement();if(!_50||!_64||!_122)return isc.emptyString;var _123=this.grid.getCanvasName()+this.grid.$34l,_85,_86;var _124=this.grid.getCanvasName()+this.grid.$349;while(_50!=this.tableElement&&_50!=_64&&_50.getAttribute){var _31=_50.getAttribute("name");if(_31){if(_31.startsWith(_123)){_85=parseInt(_31.substring(_123.length));_86=this.grid.getTreeFieldNum();return this.getCellLocator(_85,_86)+"/open"}
if(_31.startsWith(_124)){_85=parseInt(_31.substring(_124.length));_86=this.grid.getTreeFieldNum();return this.getCellLocator(_85,_86)+"/extra"}}
_50=_50.parentNode}
return this.Super("getInteriorLocator",[_63])},getInnerElementFromSplitLocator:function treeGrid_getInnerElementFromSplitLocator(_164){if(this.emptyLocatorArray(_164))return this.getHandle();if(_164.length==3){if(_164[2]=="open"){if(this.$29p())return null;var _116=_164[0];var _85;if(_116.charAt(3)!="["){_85=parseInt(_116.substring(3))}else{var _117=isc.AutoTest.parseLocatorFallbackPath(_116);if(_117==null||_117.name!="row"){this.logInfo("Locator appears to be click-in-open-area locator but "+"doesn't contain row/col info? returning null.\n"+_164.join("/"),"AutoTest")}
_85=this.grid.getRowNumFromLocatorConfig(_117.config)}
var _125=this.grid.$34l+_85,_66=this.grid.getImage(_125);if(_66)return _66}else if(_164[2]=="extra"){if(this.$29p())return null;var _116=_164[0];var _85;if(_116.charAt(3)!="["){_85=parseInt(_116.substring(3))}else{var _117=isc.AutoTest.parseLocatorFallbackPath(_116);if(_117==null||_117.name!="row"){this.logInfo("Locator appears to be click-in-open-area locator but "+"doesn't contain row/col info? returning null.\n"+_164.join("/"),"AutoTest")}
_85=this.grid.getRowNumFromLocatorConfig(_117.config)}
var _125=this.grid.$349+_85,_66=this.grid.getImage(_125);if(_66)return _66}}
return this.Super("getInnerElementFromSplitLocator",arguments)},getAutoTestLocatorCoords:function treeGrid_getAutoTestLocatorCoords(_68,_50){var _126=this.Super("getAutoTestLocatorCoords",arguments);if(_126==null)return _126;var _127=this.grid;if(_127==null||_68.endsWith("open")||_68.endsWith("extra"))return _126;var y=_126[1],_85=this.getEventRow(y),_86=this.getEventColumn(_126[0]),_121=_127.data,_129=_127.getRecord(_85),_130=_127.getTreeFieldNum()==_127.getFieldNumFromLocal(_86,this);if(_130&&_127.data&&_127.data.isFolder(_129)){var _131=_127.getOpenAreaWidth(_129),_51=isc.Element.getElementRect(_50),_52=(_51[0]+_131),_53=_51[2]-_52;_126[0]=_52+Math.floor(_53/ 2)}
return _126}})}
if(isc.TabSet){isc.TabSet.addProperties({containsLocatorChild:function tabSet_containsLocatorChild(_39){if(this.Super("containsLocatorChild",arguments))return true;if(this.getTabNumber(_39)!=-1)return true;return false},getStandardChildLocator:function tabSet_getStandardChildLocator(_39){var _132=this.getTabNumber(_39);if(_132!=-1){var _133=this.getTabObject(_132);var _134={};if(_133.ID!=null)_134.ID=_133.ID;if(_133.title!=null)_134.title=_133.title;_134.index=_132;return isc.AutoTest.createLocatorFallbackPath("tab",_134)}
return this.Super("getStandardChildLocator",arguments)},getChildFromLocatorSubstring:function tabSet_getChildFromLocatorSubstring(_164){if(_164&&_164.startsWith("tab[")){var _135=isc.AutoTest.parseLocatorFallbackPath(_164),_43=_135.config;if(_43.ID!=null){return this.getTab(_43.ID)}
var _136=this.locateTabsBy;if(_136==null)_136="title";if(_43.title&&_136=="title"){var _132=this.tabs.findIndex("title",_43.title);return this.getTab(_132)}
return this.getTab(parseInt(_43.index))}
return this.Super("getChildFromLocatorSubstring",arguments)}})}
if(isc.StatefulCanvas){isc.StatefulCanvas.addProperties({getInnerElementFromSplitLocator:function statefulCanvas_getInnerElementFromSplitLocator(_164){if(!this.emptyLocatorArray(_164)&&this.label){return this.label.getInnerElementFromSplitLocator(_164)}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.DateChooser){isc.DateChooser.addMethods({getInteriorLocator:function dateChooser_getInteriorLocator(_50){var _64=this.getHandle();if(!_64||!_50)return"";var _137=_50.$73l;if(_137!=null&&_137!="")return _137;return _50.$73l=this.$73m(_50,_64)},$73m:function dateChooser__getInteriorLocator(_50,_64){var _138=_50;while(_138&&_138!=null){if(_138==_64){_138=null;break}
if(_138.tagName&&_138.tagName.toLowerCase()=="td"){break}
_138=_138.parentElement}
if(_138==null)return"";var _139=_64.childNodes,_140=[];for(var i=0;i<_139.length;i++){if(!_139[i].tagName||_139[i].tagName.toLowerCase()!="table"){continue}
_140[_140.length]=_139[i]}
var _141=_140.length==2?_140[0]:null,_142=_140.length==2?_140[1]:_140[0];if(_141!=null&&_138.offsetParent==_141){var _143=_138.onclick,_144=_143?_143.toString():null;if(!_144)return"";if(_144.contains("showPrevYear")){return"prevYearButton"}else if(_144.contains("showNextYear")){return"nextYearButton"}else if(_144.contains("showPrevMonth")){return"prevMonthButton"}else if(_144.contains("showNextMonth")){return"nextMonthButton"}else if(_144.contains("showMonthMenu")){return"monthMenuButton"}else if(_144.contains("showYearMenu")){return"yearMenuButton"}
return""}else if(_142!=null&&_138.offsetParent==_142){var _143=_138.onclick,_144=_143?_143.toString():null;if(!_144)return"";if(_144.contains("cancelClick"))return"cancelButton";else if(_144.contains("todayClick"))return"todayButton";else{var _145=_144.match("dateClick\\(\(.*\)\\)");if(_145&&_145[1]){var _146=_145[1].split(",");for(var i=0;i<_146.length;i++){_146[i]=_146[i].trim()}
return _146.join("/")}}}
return""},getInnerElementFromSplitLocator:function dateChooser_getInnerElementFromSplitLocator(_164){if(this.emptyLocatorArray(_164))return this.getHandle();var _64=this.getHandle();if(_64==null)return;var _147=(_164.length==3);if(!_147){var _59=_164[0];if(_59=="")return _64;var _148=(_59=="todayButton"),_149=!_148?(_59=="cancelButton"):false;var _139=_64.childNodes;if(_148||_149){if(_148&&!this.showTodayButton){this.logWarn("DateChooser attempting to locate element for "+"'todayButton' but showTodayButton is false. Returning handle.","AutoTest");return _64}
if(_149&&!this.showCancelButton){this.logWarn("DateChooser attempting to locate element for "+"'cancelButton' but showCancelButton is false. Returning handle.","AutoTest");return _64}
var _142;for(var i=_139.length-1;i>=0;i--){if(_139[i].tagName&&_139[i].tagName.toLowerCase()=="table")
{_142=_139[i];break}}
var _150=_142.rows[_142.rows.length-1],_96=_150.cells;for(var i=0;i<_96.length;i++){if(this.getInteriorLocator(_96[i])==_59){return _96[i]}}}else{if(!this.showHeader){this.logWarn("DateChooser attempting to locate element for "+_164+" but this.showHeader is false so this element will not be present. "+"Returning handle.","AutoTest");return _64}
var _141
for(var i=0;i<_139.length;i++){if(_139[i].tagName&&_139[i].tagName.toLowerCase()=="table")
{_141=_139[i];break}}
var _90=_141.rows[0],_96=_90.cells;for(var i=0;i<_96.length;i++){if(this.getInteriorLocator(_96[i])==_59){return _96[i]}}}}else{var _151=_164[0],_152=_164[1],_153=_164[2];if((_151==this.year)&&(this.month==_152||this.month==_152+1||this.month==_152-1))
{var _154=Date.createLogicalDate(_151,_152,_153),_155=_154.getDay();if(this.showWeekends||!Date.getWeekendDays().contains(_155)){var _156=Date.createLogicalDate(this.year,this.month,1);var _157=_156.getDay(),_158=_157+this.firstDayOfWeek-
(_157<this.firstDayOfWeek?7:0);_156.setDate(_156.getDate()-_158);this.logWarn("checking for date on weekday -- start:"+_156+", button date:"+_154);if(Date.compareDates(_154,_156)!=1){var _159=Date.createLogicalDate(this.year,this.month+1,1);_159.setTime(_159.getTime()-86400000);this.logWarn("checking for date on weekday -- end:"+_159+", button date:"+_154);var _160=_159.getDay(),_161=this.firstDayOfWeek+6;if(_161>6)_161-=7;var _162=_161>_160?_161-_160:_161+7-_160;if(_162!=0){_159.setTime(_159.getTime()+(86400000*_162))}
if(Date.compareDates(_154,_159)!=-1){var _85=Math.floor(((parseInt(_153)+_158)/7))
_85+=1;var _163=this.firstDayOfWeek;if(!this.showWeekends){while(Date.getWeekendDays().contains(_163)){_163+=1;if(_163==7)_163=0}}
var _86=_154.getDay()-_163;if(_86<0)_86+=7;var _139=_64.childNodes,_142;for(var i=_139.length-1;i>=0;i--){if(_139[i].tagName&&_139[i].tagName.toLowerCase()=="table")
{_142=_139[i];break}}
if(_142)return _142.rows[_85].cells[_86]}else{this.logInfo("DateChooser Passed ID for a date after end. "+"end date:"+[_159.getFullYear(),_159.getMonth(),_159.getDay()]+" vs:"+[_151,_152,_153],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a date before start date. "+"startDate:"+[_156.getFullYear(),_156.getMonth(),_156.getDay()]+" vs:"+[_151,_152,_153],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a weekend - not showing weekends","AutoTest")}}else{this.logInfo("DateChooser passed ID for the wrong year or month - passed:"+_164+", showing:"+[this.year,this.month],"AutoTest")}
this.logWarn("DateChooser - passed inner locator for date ("+_164.join("/")+") -- not currently showing this date.","AutoTest")}
this.logWarn("DateChooser, unable to find element for inner locator:"+_164+" returning handle");return _64}})}}
isc.AutoTest.customizeCalendar=function(){isc.$755={getRowLocatorOptions:function calendarView_getRowLocatorOptions(_47,_28,_29){var _1=this.Super("getRowLocatorOptions",arguments);var _2=this.creator.chosenDate;_1.date=_2.toSchemaDate("date");_1.minutes=_28*30;return _1},getRowNumFromLocatorConfig:function calendarView_getRowNumFromLocatorConfig(_47){var _3=this.creator.locateCellsBy;if((_3=="date"||_3==null)&&_47.date!=null)
...
this.logWarn("doesn't contain date:"+_2);return false},getColLocatorOptions:function weekSchedule_getColLocatorOptions(_47,_28,_29){var _6=this.Super("getColLocatorOptions",arguments),_7=this.getFieldNumFromLocal(_29,_47),_5=this.getField(_7);if(_5&&_5.$658!=null){_6.date=[_5.$66a,(_5.$659+1),_5.$658].join("-")}
return _6},getFieldFromColLocatorConfig:function weekSchedule_getFieldFromColLocatorConfig(_47){if((this.locateCellsBy=="date"||this.locateCellsBy==null)&&(_47.date!=null))
{var _8=_47.date.split("-");return this.getFields().find("$658",_8[2])}
return this.Super("getFieldFromColLocatorConfig",arguments)}});isc.MonthSchedule.addProperties({getRowLocatorOptions:function monthSchedule_getRowLocatorOptions(_47,_28,_29){var _1=this.Super("getRowLocatorOptions",arguments);var _9=this.getRecord(_28);if(!_9)return _1;var _5=this.getField(_29);var _10=_5.$66b;_1.dayIndex=_10;var _2=_9["date"+_10];_1.date=_2.toSchemaDate("date");var _11=_9["event"+_10];if(_11==null){_1.isHeaderRow=true}else{_1.isHeaderRow=false}
return _1},getRowNumFromLocatorConfig:function monthSchedule_getRowNumFromLocatorConfig(_47){var _3=this.creator.locateCellsBy;if((_3=="date"||_3==null)&&_47.date!=null)
...
return-1}
this.locateRowsBy="index";return this.Super("getRowNumFromLocatorConfig",arguments)},getColLocatorOptions:function monthSchedule_getColLocatorOptions(_47,_28,_29){var _1=this.Super("getColLocatorOptions",arguments);_1.dayIndex=this.getField(_29).$66b;return _1},getColNumFromLocatorConfig:function monthSchedule_getColNumFromLocatorConfig(_47){var _3=this.locateCellsBy;if(_3==null||_3=="date"){return this.fields.findIndex("$66b",parseInt(_47.dayIndex))}
this.locateColsBy="index";return this.Super("getColNumFromLocatorConfig",arguments)}});isc.MonthScheduleBody.addProperties({getInteriorLocator:function monthScheduleBody_getInteriorLocator(_47){if(_47.tagName.toLowerCase()=="a"){var _16=_47.href;if(_16!=null){var _17=_16.match("javascript:.*monthViewEventClick\\((\\d+),(\\d+),(\\d+)\\);");if(_17){var _18=parseInt(_17[1]),_19=parseInt(_17[2]),_20=parseInt(_17[3]);var _11=this.grid.getEvents(_18,_19),_21=_11[_20];if(_21==null){this.logWarn("Unable to determine event associated with apparent event "+"link element -- returning cell");return this.Super("getInteriorLocator",arguments)}
...
return this.Super("getChildFromFallbackLocator",arguments)},getEventFromLocatorConfig:function calendar_getEventFromLocatorConfig(_23){var _43=this.locateEventsBy;if(_43==null)_43="primaryKey";switch(_43){case"primaryKey":var _44=this.getDataSource();if(_44){var _33=_44.getPrimaryKeyFieldName();if(_33&&_23[_33]!=null){return this.data[this.data.findByKey(_23)]}}
