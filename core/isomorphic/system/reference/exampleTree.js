                    ...
                    },
                    {
                        ...
                        children:[
                            ...
                            },
                            {
                                ...
                                title:"Time",
                                xmlURL:"TimeItem.xml",
                                description:"\n	    TimeItem allows the user to edit a logical time value (stored internally using a JavaScript date object). This item understands most standard formats (try entering \"14:00\" or \"2pm\", for example).\n            <BR><BR>JS and XML tabs show two alternative versions of source, only one is\n             required.\n            "
                            },
                            {
                                id:"spinnerItem",
                        ...
                        children:[
                            {
                                ...
                                title:"Repositioning",
                                description:"\n                    You can rearrange Portlets via drag-and-drop. Try dragging a Portlet by its\n                    title bar to a new position above or below another Portlet. You can also\n                    drop a Portlet beside another Portlet to form a row.\n                "
                            },
                            {
                            ...
                            },
                            {
                                ...
                                description:"\n                    You can create the contents of Portlets like Windows, or by dragging components\n                    in. \n                ",
                                children:[
                                    {
                                        jsURL:"layout/portal/windowContents.js",
                                        title:"Window contents",
                                        description:"\n                            A Porlet is a subclass of Window, so you can define its contents in any of the\n                            ways that work for Windows.\n                        "
                                    },
                                    {
                                ...
                                children:[
                                    {
                                        ...
                                        title:"Column height",
                                        description:"\n                            The Portlets on the left have a height which requires the PortalLayout\n                            to scroll. By default, each column scrolls individually -- if you drag the\n                            large Portlets to the right column, then it will scroll. PortalLayouts\n                            respect the height you set for Portlets, and scroll columns if necessary.\n                            <p>\n                            If you prefer to have the whole PortalLayout scroll together, try setting the\n                            columnOverflow to \"visible\". Other combinations of overflow and columnOverflow\n                            are also possible.\n                        "
                                    },
                                    {
                                        ...
                                        title:"Column width",
                                        descriptionHeight:"160",
                                        description:"\n                            By default, PortalLayouts make their columns equal width. You can display\n                            resize bars to allow the user to change column widths.\n                            <p>\n                            Try dragging the resize bar, and see how the columns change width.\n                            <p>\n                            Try making both columns smaller ... by default, the PortalLayout will extend\n                            the last column to fill the available width (preventing underflow). You can\n                            change this behavior with the <code>preventUnderflow</code> attribute.\n                            <p>\n                            Try making both columns bigger ... by default, the PortalLayout will scroll\n                            if the columns overflow the available width.\n                        "
                                    },
                                    {
                                        id:"portletHeight",
                                        jsURL:"layout/portal/portletHeight.js",
                                        title:"Portlet height",
                                        description:"\n                            PortalLayouts distribute available column height amongst Portlets equally,\n                            or by the sizes that you specify (like an ordinary Layout).\n                            <p>\n                            By default, the PortalLayout will add space to the last Portlet in a column,\n                            if needed to fill that column. You can change that by turning \n                            <code>preventColumnUnderflow</code> off.\n                        "
                                    },
                                    {
                                        id:"portletWidth",
                                        jsURL:"layout/portal/portletWidth.js",
                                        title:"Portlet width",
                                        description:"\n                            PortalLayouts distribute available column width amongst Portlets equally,\n                            or by the sizes that you specify (like an ordinary Layout).\n                            <p>\n                            By default, the PortalLayout will add width to the last (or only) Portlet \n                            in a row in order to always fill the row. You can change that by turning\n                            <code>preventRowUnderflow</code> off.\n                        "
                                    },
                                    {
                                        id:"resizingPortlets",
                                        jsURL:"layout/portal/portletResizing.js",
                                        title:"Portlet resizing",
                                        description:"\n                            You can allow the user to drag-resize Portlets by their edges, just\n                            like resizing Windows. Try changing the height of a Portlet in a row --\n                            notice how all the Portlets in that row change height together. Notice\n                            how each column will scroll if you resize the height of Portlets to exceed the \n                            available space. If you try to resize a Portlet to leave some of the available\n                            space unused, it will snap back to fill the space.\n                        "
                                    },
                                    {
                                        id:"portalLayoutOverflowingWidth",
                                        jsURL:"layout/portal/overflow.js",
                                        title:"Overflowing width",
                                        descriptionHeight:"160",
                                        description:"\n                            If you resize a Portlet to be wider than its column, the column will\n                            stretch to accomodate the Portlet. Other columns may shrink to compensate, \n                            if their Portlets do not require the whole width.\n                            <p>\n                            Try making Portlet 1 wider -- by default, its column stretches to accomodate,\n                            and the next column shrinks. (You can prevent the stretching by turning off\n                            <code>canStretchColumnWidths</code>, and prevent the shrinking by turning off\n                            <code>canShrinkColumnWidths</code>). Then, trying moving Portlet 1 to the second\n                            column -- note how the columns change width to accommodate. Then, close\n                            Portlet 1 -- note how the columns return to their original widths.\n                            <p>\n                            If the Portlets are too wide for the PortalLayout as a whole, \n                            the PortalLayout will scroll horizontally, if <code>canStretchColumnWidths</code>\n                            is enabled. Otherwise, individual rows of Portlets will scroll.\n                        "
                                    }
                                ]
                            }
                        ]
                    ...
                    },
                    {
                        ...
                        children:[
                            ...
                            },
                            {
                                ...
                                descriptionHeight:"150",
                                description:"\n                You can dynamically include fields from related data sources\n                (without directly declaring it in data source). City DS does not have declared field \"countryCode\".\n                This field is specified in ListGrid with \"includeFrom\" property pointing to field in related Country DS.\n                For this widget only system automatically adds specified field and retrieves it's valule.\n            "
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        children:[
                            ...
                            },
                            {
                                ...
                                description:"\n            You can export HTML content to PDF object. Click the button Export to see the sample in action.<P>\n            Also you can see what will be exported with a preview, just Click the button Show Print Preview.\n        "
                            }
                        ]
                    },
                    {
