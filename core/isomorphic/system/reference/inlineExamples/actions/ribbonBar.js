...
function getIconButton (title, props) {
    return isc.IconButton.create(isc.addProperties({
            ...
            iconClick: "isc.say(this.title + ' icon clicked');"
        }, props)
    );
}
...
isc.RibbonGroup.create({
    ...
    titleAlign: "left",
    controls: [
        getIconMenuButton("New", { orientation: "vertical", menu: typeMenu, showMenuIconOver: true }),
...
isc.RibbonGroup.create({
    ...
    controls: [
        ...
        getIconButton("Paste"),
        getIconMenuButton("Undo", { menu: typeMenu, showMenuIconOver: true, icon: "pieces/16/star_grey.png" }),
